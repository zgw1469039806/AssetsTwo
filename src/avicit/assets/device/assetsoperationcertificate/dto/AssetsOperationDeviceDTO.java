 ...
 * @修改记录： 
 */
@PojoRemark(table = "assets_operation_device", object = "AssetsOperationDeviceDTO", name = "操作证设备关联表")
public class AssetsOperationDeviceDTO extends BeanDTO {
	...
	*/
	...
	@FieldRemark(column = "position_id", field = "positionId", name = "安装位置")
	/*
	 *安装位置
	 */
	private java.lang.String positionId;

	@FieldRemark(column = "valid_period", field = "validPeriod", name = "有效期(天)")
	/*
	 *有效期(天)
	 */
	private Long validPeriod;

	@FieldRemark(column = "begin_date", field = "beginDate", name = "生效日期")
	/*
	 *生效日期
	 */
	...
	@FieldRemark(column = "end_date", field = "endDate", name = "失效日期")
	/*
	 *失效日期
	 */
	...
	@FieldRemark(column = "certificate_id", field = "certificateId", name = "操作证id")
	/*
	 *操作证id
	 */
