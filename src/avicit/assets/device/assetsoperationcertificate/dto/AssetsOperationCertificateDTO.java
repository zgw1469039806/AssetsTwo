package avicit.assets.device.assetsoperationcertificate.dto;
 ...
 * @修改记录： 
 */
@PojoRemark(table = "assets_operation_certificate", object = "AssetsOperationCertificateDTO", name = "操作证台账")
public class AssetsOperationCertificateDTO extends BeanDTO {
	...
	*/
	...
	@FieldRemark(column = "certificate_name", field = "certificateName", name = "操作证名称")
	/*
	 *操作证名称
	 */
	private java.lang.String certificateName;

	@FieldRemark(column = "certificate_num", field = "certificateNum", name = "操作证编号")
	/*
	 *操作证编号
	 */
	private java.lang.String certificateNum;

	@FieldRemark(column = "certificate_type", field = "certificateType", name = "操作证类型")
	/*
	 *操作证类型
	 */
	private java.lang.String certificateType;

	@FieldRemark(column = "certificate_status", field = "certificateStatus", name = "操作证状态")
	/*
	 *操作证状态
	 */
	private java.lang.String certificateStatus;

	@FieldRemark(column = "certificate_device_count", field = "certificateDeviceCount", name = "操作证设备数量")
	/*
	 *操作证设备数量
	 */
	private Long certificateDeviceCount;

	@FieldRemark(column = "certificate_info", field = "certificateInfo", name = "操作证描述")
	/*
	 *操作证描述
	 */
	private java.lang.String certificateInfo;

	@FieldRemark(column = "holder_id", field = "holderId", name = "持证人")
	/*
	 *持证人
	 */
	 ...
	 *持证人显示字段
	 */
	private java.lang.String holderIdAlias;

	@FieldRemark(column = "holder_dept", field = "holderDept", name = "持证人部门")
	/*
	 *持证人部门
	 */
	private java.lang.String holderDept;
	/*
	 *持证人部门显示字段
	 */
	private java.lang.String holderDeptAlias;

	@FieldRemark(column = "holder_phone", field = "holderPhone", name = "持证人联系方式")
	/*
	 *持证人联系方式
	 */
	private java.lang.String holderPhone;

	@FieldRemark(column = "manager_dept", field = "managerDept", name = "发证部门")
	/*
	 *发证部门
	 */
	private java.lang.String managerDept;
	/*
	 *发证部门显示字段
	 */
	private java.lang.String managerDeptAlias;

	@FieldRemark(column = "manager_id", field = "managerId", name = "发证人")
	/*
	 *发证人
	 */
	...
	@FieldRemark(column = "created_date", field = "createdDate", name = "发证日期")
	/*
	 *发证日期
	 */
	...
	@FieldRemark(column = "serial_number", field = "serialNumber", name = "序号")
	/*
	 *序号
	 */
	...
	public Long getCertificateDeviceCount() {
		return certificateDeviceCount;
	}

	public void setCertificateDeviceCount(Long certificateDeviceCount) {
		this.certificateDeviceCount = certificateDeviceCount;
	}
	...
	public void setCertificateInfo(java.lang.String certificateInfo) {
	...
	public java.lang.String getHolderIdAlias() {
		return holderIdAlias;
	}

	public void setHolderIdAlias(java.lang.String holderIdAlias) {
		this.holderIdAlias = holderIdAlias;
	}

	public java.lang.String getHolderDept() {
		return holderDept;
	}

	public void setHolderDept(java.lang.String holderDept) {
		this.holderDept = holderDept;
	}

	public java.lang.String getHolderDeptAlias() {
		return holderDeptAlias;
	}

	public void setHolderDeptAlias(java.lang.String holderDeptAlias) {
		this.holderDeptAlias = holderDeptAlias;
	}

	public java.lang.String getHolderPhone() {
		return holderPhone;
	}

	public void setHolderPhone(java.lang.String holderPhone) {
		this.holderPhone = holderPhone;
	}

	public java.lang.String getManagerDept() {
		return managerDept;
	}

	public void setManagerDept(java.lang.String managerDept) {
		this.managerDept = managerDept;
	}

	public java.lang.String getManagerDeptAlias() {
		return managerDeptAlias;
	}

	public void setManagerDeptAlias(java.lang.String managerDeptAlias) {
		this.managerDeptAlias = managerDeptAlias;
	}
