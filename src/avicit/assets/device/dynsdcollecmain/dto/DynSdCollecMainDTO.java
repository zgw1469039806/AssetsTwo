 ...
 * @类说明：DYN_SD_COLLEC_MAIN
 * @修改记录：
 */
@PojoRemark(table = "dyn_sd_collec_main", object = "DynSdCollecMainDTO", name = "DYN_SD_COLLEC_MAIN")
public class DynSdCollecMainDTO extends BeanDTO {
    ...
    @FieldRemark(column = "person_deadline", field = "personDeadline", name = "个人上报截至日期")
    /*
     *个人上报截至日期
     */
    private java.util.Date personDeadline;
    /*
     *个人上报截至日期开始时间
     */
    private java.util.Date personDeadlineBegin;
    /*
     *个人上报截至日期截止时间
     */
    private java.util.Date personDeadlineEnd;
    ...
    public java.util.Date getPersonDeadline() {
        return personDeadline;
    }

    public void setPersonDeadline(java.util.Date personDeadline) {
        this.personDeadline = personDeadline;
    }

    public java.util.Date getPersonDeadlineBegin() {
        return personDeadlineBegin;
    }

    public void setPersonDeadlineBegin(java.util.Date personDeadlineBegin) {
        this.personDeadlineBegin = personDeadlineBegin;
    }

    public java.util.Date getPersonDeadlineEnd() {
        return personDeadlineEnd;
    }

    public void setPersonDeadlineEnd(java.util.Date personDeadlineEnd) {
        this.personDeadlineEnd = personDeadlineEnd;
    }
