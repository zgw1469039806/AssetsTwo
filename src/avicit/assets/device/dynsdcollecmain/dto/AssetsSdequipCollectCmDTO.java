package avicit.assets.device.dynsdcollecmain.dto;
 ...
 * @修改记录：
 */
@PojoRemark(table = "assets_sdequip_collect_cm", object = "AssetsSdequipCollectCmDTO", name = "标准设备年度申购征集表单确认表")
public class AssetsSdequipCollectCmDTO extends BeanDTO {
     ...
     *设备购置类型显示名称
     */
    private String devicePurchaseTypeName;
     ...
     *审批总师显示字段
     */
    private String examineApproveEngineerAlias;
     ...
     *专业审核员显示字段
     */
    private String professionalAuditorAlias;
    ...
    @FieldRemark(column = "position_id", field = "positionId", name = "安装地点（未使用）")
    /*
     *安装地点（未使用）
     */
    private String positionId;

    @FieldRemark(column = "parent_id", field = "parentId", name = "标准设备年度申购征集通知单id")
    /*
     *标准设备年度申购征集通知单id
     */
    ...
    public String getDevicePurchaseTypeName() {
        return devicePurchaseTypeName;
    }

    public void setDevicePurchaseTypeName(String devicePurchaseTypeName) {
        this.devicePurchaseTypeName = devicePurchaseTypeName;
    }
    ...
    public String getExamineApproveEngineerAlias() {
        return examineApproveEngineerAlias;
    }

    public void setExamineApproveEngineerAlias(String examineApproveEngineerAlias) {
        this.examineApproveEngineerAlias = examineApproveEngineerAlias;
    }
    ...
    public String getProfessionalAuditorAlias() {
        return professionalAuditorAlias;
    }

    public void setProfessionalAuditorAlias(String professionalAuditorAlias) {
        this.professionalAuditorAlias = professionalAuditorAlias;
    }
