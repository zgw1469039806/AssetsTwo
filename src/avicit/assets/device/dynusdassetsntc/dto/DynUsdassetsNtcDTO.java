 ...
 * @类说明：DYN_USDASSETS_NTC
 * @修改记录：
 */
@PojoRemark(table = "dyn_usdassets_ntc", object = "DynUsdassetsNtcDTO", name = "DYN_USDASSETS_NTC")
public class DynUsdassetsNtcDTO extends BeanDTO {
    ...
    @FieldRemark(column = "author", field = "author", name = "申请人")
    /*
     *申请人
     */
