package avicit.assets.device.assetsfrmlossproc.dto;
 ...
 * @类说明：ASSETS_FRMLOSS_PROC
 * @修改记录：
 */
@PojoRemark(table = "assets_frmloss_proc", object = "AssetsFrmlossProcDTO", name = "ASSETS_FRMLOSS_PROC")
public class AssetsFrmlossProcDTO extends BeanDTO {
    ...
    @FieldRemark(column = "frmloss_no", field = "frmlossNo", name = "报损编号")
    /*
     *报损编号
     */
    private java.lang.String frmlossNo;
    ...
    @FieldRemark(column = "owner_mobile", field = "ownerMobile", name = "责任人联系电话")
    /*
     *责任人联系电话
     */
    ...
    @FieldRemark(column = "original_value", field = "originalValue", name = "账面原值")
    /*
     *账面原值
     */
    ...
    @FieldRemark(column = "net_value", field = "netValue", name = "账面净值")
    /*
     *账面净值
     */
    private java.math.BigDecimal netValue;

    @FieldRemark(column = "net_salvage", field = "netSalvage", name = "预计净残值")
    /*
     *预计净残值
     */
    private java.math.BigDecimal netSalvage;

    @FieldRemark(column = "net_loss_value", field = "netLossValue", name = "净报损金额")
    /*
     *净报损金额
     */
    private java.math.BigDecimal netLossValue;

    @FieldRemark(column = "frmloss_reason", field = "frmlossReason", name = "报损原因")
    /*
     *报损原因
     */
    private java.lang.String frmlossReason;

    @FieldRemark(column = "risk_analysis", field = "riskAnalysis", name = "有关产品的风险分析")
    /*
     *有关产品的风险分析
     */
    private java.lang.String riskAnalysis;

    @FieldRemark(column = "recycle_warehouse", field = "recycleWarehouse", name = "回收库")
    /*
     *回收库
     */
    private java.lang.String recycleWarehouse;

    @FieldRemark(column = "if_recycle", field = "ifRecycle", name = "是否已回收")
    /*
     *是否已回收
     */
    private java.lang.String ifRecycle;
    ...
    public java.lang.String getFrmlossNo() {
        return frmlossNo;
    }

    public void setFrmlossNo(java.lang.String frmlossNo) {
        this.frmlossNo = frmlossNo;
    }
    ...
    public java.math.BigDecimal getNetLossValue() {
        return netLossValue;
    }

    public void setNetLossValue(java.math.BigDecimal netLossValue) {
        this.netLossValue = netLossValue;
    }

    public java.lang.String getFrmlossReason() {
        return frmlossReason;
    }

    public void setFrmlossReason(java.lang.String frmlossReason) {
        this.frmlossReason = frmlossReason;
    }

    public java.lang.String getRiskAnalysis() {
        return riskAnalysis;
    }

    public void setRiskAnalysis(java.lang.String riskAnalysis) {
        this.riskAnalysis = riskAnalysis;
    }

    public java.lang.String getRecycleWarehouse() {
        return recycleWarehouse;
    }

    public void setRecycleWarehouse(java.lang.String recycleWarehouse) {
        this.recycleWarehouse = recycleWarehouse;
    }

    public java.lang.String getIfRecycle() {
        return ifRecycle;
    }

    public void setIfRecycle(java.lang.String ifRecycle) {
        this.ifRecycle = ifRecycle;
    }
