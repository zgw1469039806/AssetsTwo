 ...
 * @修改记录：
 */
@PojoRemark(table = "classify_data", object = "ClassifyDataDTO", name = "CLASSIFY_DATA")
public class ClassifyDataDTO extends BeanDTO {
    ...
    @FieldRemark(column = "parent_id", field = "parentId", name = "父分类ID")
    /*
     *父分类ID
     */
    ...
    @FieldRemark(column = "tree_path", field = "treePath", name = "分类TreePath")
    /*
     *分类TreePath
     */
    private java.lang.String treePath;

    @FieldRemark(column = "classify_state", field = "classifyState", name = "分类状态")
    /*
     *分类状态
     */
    private java.lang.String classifyState;

    @FieldRemark(column = "belong_category", field = "belongCategory", name = "所属类别")
    /*
     *所属类别
     */
    private java.lang.String belongCategory;
    ...
    public java.lang.String getClassifyState() {
        return classifyState;
    }

    public void setClassifyState(java.lang.String classifyState) {
        this.classifyState = classifyState;
    }

    public java.lang.String getBelongCategory() {
        return belongCategory;
    }

    public void setBelongCategory(java.lang.String belongCategory) {
