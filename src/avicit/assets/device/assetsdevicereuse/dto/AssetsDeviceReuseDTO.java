 ...
 * @修改记录： 
 */
@PojoRemark(table = "assets_device_reuse", object = "AssetsDeviceReuseDTO", name = "设备再用")
public class AssetsDeviceReuseDTO extends BeanDTO {
	...
	*/
	...
	@FieldRemark(column = "reuse_reason", field = "reuseReason", name = "再用原因")
	/*
	 *再用原因
	 */
	...
	@FieldRemark(column = "total_reuse_money", field = "totalReuseMoney", name = "再用总金额")
	/*
	 *再用总金额
	 */
	private java.math.BigDecimal totalReuseMoney;
	...
	public java.math.BigDecimal getTotalReuseMoney() {
		return totalReuseMoney;
	}

	public void setTotalReuseMoney(java.math.BigDecimal totalReuseMoney) {
		this.totalReuseMoney = totalReuseMoney;
	}
