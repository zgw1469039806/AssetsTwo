package avicit.assets.device.assetsdevicerchecktemporary.dto;
 ...
 * @修改记录： 
 */
@PojoRemark(table = "assets_device_rcheck_temporary", object = "AssetsDeviceRcheckTemporaryDTO", name = "定期检查设备详情表")
public class AssetsDeviceRcheckTemporaryDTO extends BeanDTO {
	...
	@FieldRemark(column = "proc_id", field = "procId", name = "计划ID")
	/*
	 *计划ID
	 */
	...
	@FieldRemark(column = "regular_check_date", field = "regularCheckDate", name = "定检时间")
	@JsonFormat(pattern = "yyyy-MM-dd", timezone = "GMT+8")
	/*
	 *定检时间
	 */
	private java.util.Date regularCheckDate;
	@JsonFormat(pattern = "yyyy-MM-dd", timezone = "GMT+8")
	/*
	 *定检时间开始时间
	 */
	private java.util.Date regularCheckDateBegin;
	@JsonFormat(pattern = "yyyy-MM-dd", timezone = "GMT+8")
	/*
	 *定检时间截止时间
	 */
	private java.util.Date regularCheckDateEnd;
	...
	public java.util.Date getRegularCheckDate() {
		return regularCheckDate;
	}

	public void setRegularCheckDate(java.util.Date regularCheckDate) {
		this.regularCheckDate = regularCheckDate;
	}

	public java.util.Date getRegularCheckDateBegin() {
		return regularCheckDateBegin;
	}

	public void setRegularCheckDateBegin(java.util.Date regularCheckDateBegin) {
		this.regularCheckDateBegin = regularCheckDateBegin;
	}

	public java.util.Date getRegularCheckDateEnd() {
		return regularCheckDateEnd;
	}

	public void setRegularCheckDateEnd(java.util.Date regularCheckDateEnd) {
		this.regularCheckDateEnd = regularCheckDateEnd;
	}
