package avicit.assets.device.assetstdevicecomponent.dto;
 ...
 * @修改记录： 
 */
@PojoRemark(table = "assets_tdevice_component", object = "AssetsTdeviceComponentDTO", name = "测试设备组件")
public class AssetsTdeviceComponentDTO extends BeanDTO {
	...
	@FieldRemark(column = "component_model", field = "componentModel", name = "组件型号")
	/*
	 *组件型号
	 */
	private String componentModel;

	@FieldRemark(column = "component_num", field = "componentNum", name = "组件编号")
	/*
	 *组件编号
	 */
	...
	@FieldRemark(column = "component_name", field = "componentName", name = "组件名称")
	/*
	 *组件名称
	 */
	private String componentName;

	@FieldRemark(column = "component_manufacturer", field = "componentManufacturer", name = "厂家名称")
	/*
	 *厂家名称
	 */
	private String componentManufacturer;

	@FieldRemark(column = "component_install_position", field = "componentInstallPosition", name = "安装槽位")
	/*
	 *安装槽位
	 */
	private String componentInstallPosition;

	@FieldRemark(column = "component_driver_id", field = "componentDriverId", name = "驱动ID")
	/*
	 *驱动ID
	 */
	private String componentDriverId;

	@FieldRemark(column = "component_driver_version", field = "componentDriverVersion", name = "驱动版本")
	/*
	 *驱动版本
	 */
	private String componentDriverVersion;

	@FieldRemark(column = "component_logic_id", field = "componentLogicId", name = "逻辑ID")
	/*
	 *逻辑ID
	 */
	private String componentLogicId;

	@FieldRemark(column = "component_logic_version", field = "componentLogicVersion", name = "逻辑版本")
	/*
	 *逻辑版本
	 */
	private String componentLogicVersion;

	@FieldRemark(column = "component_document", field = "componentDocument", name = "组件资料")
	/*
	 *组件资料
	 */
	private String componentDocument;
	...
	public String getComponentInstallPosition() {
		return componentInstallPosition;
	}

	public void setComponentInstallPosition(String componentInstallPosition) {
		this.componentInstallPosition = componentInstallPosition;
	}

	public String getComponentDriverId() {
		return componentDriverId;
	}

	public void setComponentDriverId(String componentDriverId) {
		this.componentDriverId = componentDriverId;
	}

	public String getComponentDriverVersion() {
		return componentDriverVersion;
	}

	public void setComponentDriverVersion(String componentDriverVersion) {
		this.componentDriverVersion = componentDriverVersion;
	}

	public String getComponentLogicId() {
		return componentLogicId;
	}

	public void setComponentLogicId(String componentLogicId) {
		this.componentLogicId = componentLogicId;
	}

	public String getComponentLogicVersion() {
		return componentLogicVersion;
	}

	public void setComponentLogicVersion(String componentLogicVersion) {
		this.componentLogicVersion = componentLogicVersion;
	}

	public String getComponentDocument() {
		return componentDocument;
	}

	public void setComponentDocument(String componentDocument) {
