package avicit.assets.device.assetsdeviceachecktemporary.dto;
 ...
 * @类说明：ASSETS_DEVICE_ACHECK_TEMPORARY
 * @修改记录： 
 */
@PojoRemark(table = "assets_device_acheck_temporary", object = "AssetsDeviceAcheckTemporaryDTO", name = "ASSETS_DEVICE_ACHECK_TEMPORARY")
public class AssetsDeviceAcheckTemporaryDTO extends BeanDTO {
	...
	public String getLogFormName() {
		if (super.logFormName == null || super.logFormName.equals("")) {
			return "ASSETS_DEVICE_ACHECK_TEMPORARY";
		} else {
