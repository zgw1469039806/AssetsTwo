package avicit.assets.device.assetsdevicercheckproc.dto;
 ...
 * @修改记录： 
 */
@PojoRemark(table = "assets_device_rcheck_plan", object = "AssetsDeviceRcheckPlanDTO", name = "定期检查设备详情表")
public class AssetsDeviceRcheckPlanDTO extends BeanDTO {
	...
	*/
	...
	@FieldRemark(column = "regular_check_date", field = "regularCheckDate", name = "定检检时间")
	/*
	 *定检检时间
	 */
