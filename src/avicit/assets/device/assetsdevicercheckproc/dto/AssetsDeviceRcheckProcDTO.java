 ...
 * @修改记录： 
 */
@PojoRemark(table = "assets_device_rcheck_proc", object = "AssetsDeviceRcheckProcDTO", name = "定期检查列表主表")
public class AssetsDeviceRcheckProcDTO extends BeanDTO {
	...
	*/
	...
	@FieldRemark(column = "checks_no", field = "checksNo", name = "定检单号")
	/*
	 *定检单号
	 */
	private java.lang.String checksNo;
	...
	@FieldRemark(column = "generate_by", field = "generateBy", name = "生成人")
	/*
	 *生成人
	 */
	...
	@FieldRemark(column = "checks_number", field = "checksNumber", name = "定检设备数")
	/*
	 *定检设备数
	 */
	private Long checksNumber;
	...
	@FieldRemark(column = "next_regular_start_date", field = "nextRegularStartDate", name = "定检开始时间")
	/*
	 *定检开始时间
	 */
	private java.util.Date nextRegularStartDate;
	/*
	 *定检开始时间开始时间
	 */
	private java.util.Date nextRegularStartDateBegin;
	/*
	 *定检开始时间截止时间
	 */
	private java.util.Date nextRegularStartDateEnd;

	@FieldRemark(column = "next_regular_end_date", field = "nextRegularEndDate", name = "定检结束时间")
	/*
	 *定检结束时间
	 */
	private java.util.Date nextRegularEndDate;
	/*
	 *定检结束时间开始时间
	 */
	private java.util.Date nextRegularEndDateBegin;
	/*
	 *定检结束时间截止时间
	 */
	private java.util.Date nextRegularEndDateEnd;
	...
	public java.lang.String getChecksNo() {
		return checksNo;
	}

	public void setChecksNo(java.lang.String checksNo) {
	...
	public Long getChecksNumber() {
		return checksNumber;
	}

	public void setChecksNumber(Long checksNumber) {
	...
	public java.util.Date getNextRegularStartDate() {
		return nextRegularStartDate;
	}

	public void setNextRegularStartDate(java.util.Date nextRegularStartDate) {
		this.nextRegularStartDate = nextRegularStartDate;
	}

	public java.util.Date getNextRegularStartDateBegin() {
		return nextRegularStartDateBegin;
	}

	public void setNextRegularStartDateBegin(java.util.Date nextRegularStartDateBegin) {
		this.nextRegularStartDateBegin = nextRegularStartDateBegin;
	}

	public java.util.Date getNextRegularStartDateEnd() {
		return nextRegularStartDateEnd;
	}

	public void setNextRegularStartDateEnd(java.util.Date nextRegularStartDateEnd) {
		this.nextRegularStartDateEnd = nextRegularStartDateEnd;
	}

	public java.util.Date getNextRegularEndDate() {
		return nextRegularEndDate;
	}

	public void setNextRegularEndDate(java.util.Date nextRegularEndDate) {
		this.nextRegularEndDate = nextRegularEndDate;
	}

	public java.util.Date getNextRegularEndDateBegin() {
		return nextRegularEndDateBegin;
	}

	public void setNextRegularEndDateBegin(java.util.Date nextRegularEndDateBegin) {
		this.nextRegularEndDateBegin = nextRegularEndDateBegin;
	}

	public java.util.Date getNextRegularEndDateEnd() {
		return nextRegularEndDateEnd;
	}

	public void setNextRegularEndDateEnd(java.util.Date nextRegularEndDateEnd) {
		this.nextRegularEndDateEnd = nextRegularEndDateEnd;
	}
