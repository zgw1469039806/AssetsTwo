 ...
 * @修改记录： 
 */
@PojoRemark(table = "assets_device_acheck_proc", object = "AssetsDeviceAcheckProcDTO", name = "设备精度检查计划表")
public class AssetsDeviceAcheckProcDTO extends BeanDTO {
	...
	*/
	...
	@FieldRemark(column = "acheck_code", field = "acheckCode", name = "精度检查单号")
	/*
	 *精度检查单号
	 */
	private java.lang.String acheckCode;
	...
	@FieldRemark(column = "acheck_number", field = "acheckNumber", name = "精度检查数量")
	/*
	 *精度检查数量
	 */
	private Long acheckNumber;
	...
	@FieldRemark(column = "next_acc_start_date", field = "nextAccStartDate", name = "精度检查开始时间")
	/*
	 *精度检查开始时间
	 */
	private java.util.Date nextAccStartDate;
	/*
	 *精度检查开始时间开始时间
	 */
	private java.util.Date nextAccStartDateBegin;
	/*
	 *精度检查开始时间截止时间
	 */
	private java.util.Date nextAccStartDateEnd;

	@FieldRemark(column = "next_acc_end_date", field = "nextAccEndDate", name = "精度检查结束时间")
	/*
	 *精度检查结束时间
	 */
	private java.util.Date nextAccEndDate;
	/*
	 *精度检查结束时间开始时间
	 */
	private java.util.Date nextAccEndDateBegin;
	/*
	 *精度检查结束时间截止时间
	 */
	private java.util.Date nextAccEndDateEnd;
	...
	public java.lang.String getAcheckCode() {
		return acheckCode;
	}

	public void setAcheckCode(java.lang.String acheckCode) {
		this.acheckCode = acheckCode;
	}
	...
	public Long getAcheckNumber() {
		return acheckNumber;
	}

	public void setAcheckNumber(Long acheckNumber) {
		this.acheckNumber = acheckNumber;
	}
	...
	public java.util.Date getNextAccStartDate() {
		return nextAccStartDate;
	}

	public void setNextAccStartDate(java.util.Date nextAccStartDate) {
		this.nextAccStartDate = nextAccStartDate;
	}

	public java.util.Date getNextAccStartDateBegin() {
		return nextAccStartDateBegin;
	}

	public void setNextAccStartDateBegin(java.util.Date nextAccStartDateBegin) {
		this.nextAccStartDateBegin = nextAccStartDateBegin;
	}

	public java.util.Date getNextAccStartDateEnd() {
		return nextAccStartDateEnd;
	}

	public void setNextAccStartDateEnd(java.util.Date nextAccStartDateEnd) {
		this.nextAccStartDateEnd = nextAccStartDateEnd;
	}

	public java.util.Date getNextAccEndDate() {
		return nextAccEndDate;
	}

	public void setNextAccEndDate(java.util.Date nextAccEndDate) {
		this.nextAccEndDate = nextAccEndDate;
	}

	public java.util.Date getNextAccEndDateBegin() {
		return nextAccEndDateBegin;
	}

	public void setNextAccEndDateBegin(java.util.Date nextAccEndDateBegin) {
		this.nextAccEndDateBegin = nextAccEndDateBegin;
	}

	public java.util.Date getNextAccEndDateEnd() {
		return nextAccEndDateEnd;
	}

	public void setNextAccEndDateEnd(java.util.Date nextAccEndDateEnd) {
		this.nextAccEndDateEnd = nextAccEndDateEnd;
	}
