 ...
 * @修改记录： 
 */
@PojoRemark(table = "assets_device_unusedsub", object = "AssetsDeviceUnusedsubDTO", name = "设备闲置流程子表")
public class AssetsDeviceUnusedsubDTO extends BeanDTO {
	...
	*/
	...
	@FieldRemark(column = "unused_money", field = "unusedMoney", name = "净闲置金额")
	/*
	 *净闲置金额
	 */
	private java.math.BigDecimal unusedMoney;
	...
	public java.math.BigDecimal getUnusedMoney() {
		return unusedMoney;
	}

	public void setUnusedMoney(java.math.BigDecimal unusedMoney) {
