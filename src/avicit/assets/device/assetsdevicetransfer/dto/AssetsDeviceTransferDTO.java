package avicit.assets.device.assetsdevicetransfer.dto;
 ...
 * @修改记录： 
 */
@PojoRemark(table = "assets_device_transfer", object = "AssetsDeviceTransferDTO", name = "设备移交流程表")
public class AssetsDeviceTransferDTO extends BeanDTO {
	...
	*/
	...
	@FieldRemark(column = "receiver_tel", field = "receiverTel", name = "接收人电话")
	/*
	 *接收人电话
	 */
