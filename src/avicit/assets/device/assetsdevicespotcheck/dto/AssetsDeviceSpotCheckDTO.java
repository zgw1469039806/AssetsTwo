package avicit.assets.device.assetsdevicespotcheck.dto;
 ...
 * @修改记录： 
 */
@PojoRemark(table = "assets_device_spot_check", object = "AssetsDeviceSpotCheckDTO", name = "设备点检")
public class AssetsDeviceSpotCheckDTO extends BeanDTO {
	...
	@FieldRemark(column = "spot_check_num", field = "spotCheckNum", name = "点检基准书编号")
	/*
	 *点检基准书编号
	 */
	private java.lang.String spotCheckNum;

	@FieldRemark(column = "spot_check_item", field = "spotCheckItem", name = "点检项目")
	/*
	 *点检项目
	 */
	private java.lang.String spotCheckItem;

	@FieldRemark(column = "data_item", field = "dataItem", name = "数据项目")
	/*
	 *数据项目
	 */
	private java.lang.String dataItem;
	...
	public java.lang.String getSpotCheckNum() {
		return spotCheckNum;
	}

	public void setSpotCheckNum(java.lang.String spotCheckNum) {
		this.spotCheckNum = spotCheckNum;
	}

	public java.lang.String getSpotCheckItem() {
		return spotCheckItem;
	}

	public void setSpotCheckItem(java.lang.String spotCheckItem) {
