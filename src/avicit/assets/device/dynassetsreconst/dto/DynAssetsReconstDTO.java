 ...
 * @类说明：DYN_ASSETS_RECONST
 * @修改记录： 
 */
@PojoRemark(table = "dyn_assets_reconst", object = "DynAssetsReconstDTO", name = "DYN_ASSETS_RECONST")
public class DynAssetsReconstDTO extends BeanDTO {
