 ...
 * @类说明：ACCEPTANCE_DEVICE_COMPONENT
 * @修改记录：
 */
@PojoRemark(table = "acceptance_device_component", object = "AcceptanceDeviceComponentDTO", name = "ACCEPTANCE_DEVICE_COMPONENT")
public class AcceptanceDeviceComponentDTO extends BeanDTO {
	...
	@FieldRemark(column = "device_id", field = "deviceId", name = "主设备ID")
	/*
	 *主设备ID
	 */
	...
	@FieldRemark(column = "component_category", field = "componentCategory", name = "组件类别")
	/*
	 *组件类别
	 */
	 ...
	 *组件类别显示名称
	 */
	private java.lang.String componentCategoryName;
	...
	public java.lang.String getComponentCategoryName() {
		return componentCategoryName;
	}

	public void setComponentCategoryName(java.lang.String componentCategoryName) {
	...
	public String getLogFormName() {
		if (super.logFormName == null || super.logFormName.equals("")) {
			return "ACCEPTANCE_DEVICE_COMPONENT";
		} else {
