 ...
 * @修改记录：
 */
@PojoRemark(table = "assets_ustdtempapply_ct_main", object = "AssetsUstdtempapplyCtMainDTO", name = "非标设备年度申购征集上报表头")
public class AssetsUstdtempapplyCtMainDTO extends BeanDTO {
