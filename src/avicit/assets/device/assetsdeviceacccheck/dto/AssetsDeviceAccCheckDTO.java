package avicit.assets.device.assetsdeviceacccheck.dto;
 ...
 * @修改记录： 
 */
@PojoRemark(table = "assets_device_acc_check", object = "AssetsDeviceAccCheckDTO", name = "设备精度检查")
public class AssetsDeviceAccCheckDTO extends BeanDTO {
