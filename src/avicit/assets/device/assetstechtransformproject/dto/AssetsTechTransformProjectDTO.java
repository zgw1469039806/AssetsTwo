 ...
 * @类说明：ASSETS_TECH_TRANSFORM_PROJECT
 * @修改记录：
 */
@PojoRemark(table = "assets_tech_transform_project", object = "AssetsTechTransformProjectDTO", name = "ASSETS_TECH_TRANSFORM_PROJECT")
public class AssetsTechTransformProjectDTO extends BeanDTO {
    ...
    @Id
    @LogField
    @FieldRemark(column = "id", field = "id", name = "技改项目ID")
    /*
     *技改项目ID
     */
    private java.lang.String id;

    @FieldRemark(column = "tt_project_name", field = "ttProjectName", name = "技改项目名称")
    /*
     *技改项目名称
     */
    private java.lang.String ttProjectName;

    @FieldRemark(column = "chief_engineer", field = "chiefEngineer", name = "主管总师")
    /*
     *主管总师
     */
    private java.lang.String chiefEngineer;
    /*
     *主管总师显示字段
     */
    private java.lang.String chiefEngineerAlias;
    ...
    public java.lang.String getTtProjectName() {
        return ttProjectName;
    }

    public void setTtProjectName(java.lang.String ttProjectName) {
        this.ttProjectName = ttProjectName;
    }

    public java.lang.String getChiefEngineer() {
        return chiefEngineer;
    }

    public void setChiefEngineer(java.lang.String chiefEngineer) {
        this.chiefEngineer = chiefEngineer;
    }

    public java.lang.String getChiefEngineerAlias() {
        return chiefEngineerAlias;
    }

    public void setChiefEngineerAlias(java.lang.String chiefEngineerAlias) {
    ...
    public String getLogFormName() {
        if (super.logFormName == null || super.logFormName.equals("")) {
            return "ASSETS_TECH_TRANSFORM_PROJECT";
        } else {
