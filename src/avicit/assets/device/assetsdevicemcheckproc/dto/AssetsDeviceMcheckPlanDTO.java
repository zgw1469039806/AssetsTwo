 ...
 * @类说明：ASSETS_DEVICE_MCHECK_PLAN
 * @修改记录： 
 */
@PojoRemark(table = "assets_device_mcheck_plan", object = "AssetsDeviceMcheckPlanDTO", name = "ASSETS_DEVICE_MCHECK_PLAN")
public class AssetsDeviceMcheckPlanDTO extends BeanDTO {
	...
	*/
	...
	public String getLogFormName() {
		if (super.logFormName == null || super.logFormName.equals("")) {
			return "ASSETS_DEVICE_MCHECK_PLAN";
		} else {
