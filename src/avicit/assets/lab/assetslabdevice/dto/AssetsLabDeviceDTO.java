package avicit.assets.lab.assetslabdevice.dto;
 ...
 * @修改记录： 
 */
@PojoRemark(table = "assets_lab_device", object = "AssetsLabDeviceDTO", name = "实验室和设备关联表")
public class AssetsLabDeviceDTO extends BeanDTO {
	...
	@FieldRemark(column = "lab_id", field = "labId", name = "实验室id")
	/*
	 *实验室id
	 */
	...
	@FieldRemark(column = "order_state", field = "orderState", name = "预约状态")
	/*
	 *预约状态
	 */
	...
	public void setLabId(java.lang.String labId) {
		this.labId = labId;
	}
	...
	public void setOrderStateName(java.lang.String orderStateName) {
