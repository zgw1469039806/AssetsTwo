 ...
 * @类说明：ASSETS_FURNITURE_PROC
 * @修改记录： 
 */
@PojoRemark(table = "assets_furniture_proc", object = "AssetsFurnitureProcDTO", name = "ASSETS_FURNITURE_PROC")
public class AssetsFurnitureProcDTO extends BeanDTO {
