package avicit.assets.furniture.assetsfurniturescrapproc.dto;
 ...
 * @修改记录： 
 */
@PojoRemark(table = "assets_furniture_scrap_proc", object = "AssetsFurnitureScrapProcDTO", name = "家具报废")
public class AssetsFurnitureScrapProcDTO extends BeanDTO {
