package avicit.assets.furniture.furnitureclassify.dto;
 ...
 * @类说明：FURNITURE_CLASSIFY @修改记录：
 */
@PojoRemark(table = "furniture_classify", object = "NationalClassifyDTO", name = "FURNITURE_CLASSIFY")
public class FurnitureClassifyDTO extends BeanDTO {
