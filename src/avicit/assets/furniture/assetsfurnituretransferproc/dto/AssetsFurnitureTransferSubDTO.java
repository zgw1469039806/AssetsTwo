 ...
 * @修改记录： 
 */
@PojoRemark(table = "assets_furniture_transfer_sub", object = "AssetsFurnitureTransferSubDTO", name = "家具移交子表")
public class AssetsFurnitureTransferSubDTO extends BeanDTO {
