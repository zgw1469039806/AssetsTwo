 ...
 * @修改记录： 
 */
@PojoRemark(table = "assets_furniture_recovery_sub", object = "AssetsFurnitureRecoverySubDTO", name = "家具回收子表")
public class AssetsFurnitureRecoverySubDTO extends BeanDTO {
