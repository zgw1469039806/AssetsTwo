 ...
 */
function SysHistMenus(datagrid, url, searchDialogId, form, keyWordId, searchNames, dataGridColModel){
 ...
 * 初始化操作
 */
SysHistMenus.prototype.init = function(){
	var _self = this;
	$(_self._datagridId).jqGrid({
    	url: this.getUrl() + 'getSysHistMenussByPage.json',
        mtype: 'POST',
        datatype: "json",
	...
	//初始化校验字段
    																																																																																																							   					     _self.lengthValidFiled.push("menuId");
				     _self.lengthValidFiledSize.push(255);
				    																							   					     _self.lengthValidFiled.push("menuName");
				     _self.lengthValidFiledSize.push(255);
				    																							   					     _self.lengthValidFiled.push("menuCode");
				     _self.lengthValidFiledSize.push(255);
				    																							   					     _self.lengthValidFiled.push("menuUrl");
				     _self.lengthValidFiledSize.push(255);
				    																							   										};
 /**
 * 添加页面
...
SysHistMenus.prototype.insert = function(){
	var _self = this;
 ...
 * @param 
 */
SysHistMenus.prototype.nullvalid = function(data,item,nullfiled,notnullFiledComment){
	var msg = "";
 ...
 * @param 
 */
SysHistMenus.prototype.lengthvalid = function(data,item,lengthValidFiled,lengthValidFiledComment,lengthValidFiledSize){
	var msg = "";
	$.each(data,function(i,dataitem){
 ...
 * @param callback
 */
SysHistMenus.prototype.save = function(){
	var _self = this;
 ...
 * @param id
 */
SysHistMenus.prototype.detail = function(id){
 ...
 * 删除
 */
SysHistMenus.prototype.del = function(){
 ...
 * 重载数据
 */
SysHistMenus.prototype.reLoad = function(){
	var searchdata = {
		keyWord: null,
 ...
 */
SysHistMenus.prototype.openSearchForm = function(searchDiv){
	var _self = this;
 ...
 * 高级查询
 */
SysHistMenus.prototype.searchData = function(){
	var searchdata = {
		keyWord: null,
		param:JSON.stringify(serializeObject($(this._formId)))
	}
 ...
 * 关键字查询
 */
SysHistMenus.prototype.searchByKeyWord = function(){
