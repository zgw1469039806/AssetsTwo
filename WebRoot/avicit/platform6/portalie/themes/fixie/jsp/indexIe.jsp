...
<link id="theme" rel="stylesheet" type="text/css"
	href="avicit/platform6/portal/themes/fixie/css/style-ie6.css">
...
<body>
	<div class="mainBody">
		...
		<div class="header">
		  ...
		  <div class="navbar">
			...
			<div class="toolbar">
                 <div class="search">
                        <input id="keywords"  type="text" name="keyword" placeholder="请输入想搜索的内容" value="">
                        <input type="hidden" name="somehiddenvalue" value="">
                        <input id="headSubmit" type="submit">
                        <label for="headSubmit" class="icon white icon-search head-search"></label>
                </div>
				<div class="iconbtn">
					<ul>
						<li class="dropdown" id="personalMenu">
							<!-- style="color:#d8d8d8" --> <i title="常用"
 ...
 -->
	...
	<!-- jquery-tabs 脚本依赖 -->
	<script type="text/javascript"
		src="avicit/platform6/portal/themes/fixie/js/jquery.changeui.js"></script>
	<script type="text/javascript"
	...
	<script type="text/javascript"
		src="avicit/platform6/portal/themes/fixie/js/theme-top.js"></script>
