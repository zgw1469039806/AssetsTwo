					...
					<table style="width: 100%">
						<tr>
							<td>
								...
								<div class="ext-toolbar-right" style="">
								     <table  width="100%">
								     	<tr>
									     	<td width=123>
									     	...
									     	<td style="position:relative">
									     		<input
													class="easyui-validatebox ext-selector-input keySearchClass" style="width:165px;"
...
function formatContentValue(cellvalue, options, rowObject) {
	return '<a id="'+rowObject.id+'_content" onMouseEnter="SysMsgIe6.contentTips(\''
	+ rowObject.id + '_content\',\''+cellvalue+'\');" onMouseLeave="SysMsgIe6.closeContentTips();" >' + cellvalue + '</a>';
}
