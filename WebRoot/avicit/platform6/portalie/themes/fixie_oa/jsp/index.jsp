...
<head>
    ...
    <!-- 页面样式 index.css -->
    <link rel="stylesheet" type="text/css"
          href="avicit/platform6/portalie/themes/fixie_oa/css/index-ie6.css">

    <!-- 字号控制 -->
    <link rel="stylesheet" type="text/css" href="avicit/platform6/portalie/css/font-size-m.css">
<!--[if IE 7]>
    ...
    <div class="bodyCont">
        ...
        <div class="header">
            <div class="toolbar">
                    ...
                    <div class="iconbtn">
                        <ul>
                            <li class="dropdown" id="personalMenu"><i title="常用"
                                                                      class="icon grey20 icon-changyong"
                            ...
                            <%--<li class="dropdown" id="personalCollect"><i title="收藏"
                                                                         class="icon grey20 icon-shoucang"
                                                                         data-toggle="dropdown"
                                                                         aria-haspopup="true" aria-expanded="true"></i>
                                <div class="dropdown-menu dropdown-menu-right avic-dropmenu">
						...
						<div class="userinfo dropdown">
							<p class="dropdown-toggle" data-toggle="dropdown"
								...
								<span class="username">您好,[<c:out value="${userName}" />]</span>
							</p>
							<ul
								class="dropdown-menu dropdown-menu-right avic-dropmenu pull-right">
								<li class="user-card">
									<div class="usercont">
										<div class="userhead"  style="background-image:url('${userHeadURI}');*background-image:url('');filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(src='${userHeadURI}',sizingMethod='scale');  ">
                                            <i class="switch" id="userSwich"></i>
										</div>
										<div class="userbase">
											<p title="<c:out value="${userName}" />">姓名：<span><c:out value="${userName}" /></span></p>
                ...
                <iframe  src="about:blank" frameBorder=0 marginHeight=0 marginWidth=0 style="position:absolute; visibility:inherit; top:0px;left:0px;height:100%;width:100%; z-Index:-1; filter:progid:DXImageTransform.Microsoft.Alpha(style=0,opacity=0);">
                 </iframe>
			</div>
			<!-- 主页面头部工具条 End -->
    ...
    <div id="indexMenu" class="tabsSubMenu" data-for="首页" style="width:400px;">
        <ul class="indexMenuContent">
            <li class="changeUrl checked" rel="guider.html">
                <div><i></i><span class="cn">我的工作</span></div>
            </li>
        </ul>
...
<!-- 页面脚本 index.js-->
<script type="text/javascript"
        src="avicit/platform6/portalie/themes/fixie_oa/js/index-ie6.js"></script>
    ...
    $(function () {
        ...
        $("#addMessageDialog").on("click", function () {
            var addIndex = layer.open({
                ...
                content: 'avicit/platform6/portalie/themes/fixie_oa/jsp/SysMsgPubAddIe6.jsp?type=addMessageDialog'
            });
        });
