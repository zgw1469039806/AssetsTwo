...
<script type="text/javascript">
	$(function() {
		if (!"${student1DTO.birthday}" == "") {
			$('#birthday').datebox(
					'setValue',
					parserColumnTime("${student1DTO.birthday}").format(
							"yyyy-MM-dd"));
		}
		...
		<form id='form'>
			...
			<table class="form_commonTable">
				...
				<tr>
					...
					<td class="disabled" width="39%" colspan="3"><textarea title="用户名"
						class="textareabox"   name="content" id="content"
						readonly="readonly" rows="6" >${sysMsgDTO.content}</textarea></td>
				</tr>
				<tr>
					<th align="right" width="10%"
						style="word-break: break-all; word-warp: break-word;"><span
