...
<!-- ControllerPath = "mdaDatasourceEasyUIController/operation/Add/null" -->
<title>添加</title>
...
<script type="text/javascript">
	...
	function saveForm(){  
	  ...
	  if(hasvalidate){
		...
		parent.mdaDatasource.save(serializeObject($('#form')),"#insert");
	  }
	}
			...
			<table class="form_commonTable">
				<tr>
					...
					<td width="39%"><input title="USERID" class="inputbox"
						style="width: 99%;" type="hidden" name="userid" id="userid" value='${mdaDatasourceDTO.userid}'/>
						<div class="">
							<input class="easyui-validatebox" type="text" title="USERID" 
								name="useridAlias" data-options="required:true" id="useridAlias"
								readOnly="readOnly" value='<c:out  value='${mdaDatasourceDTO.useridAlias}'/>' style="width: 99%;"></input>
						</div></td>
				</tr>
				<tr>
					<th width="10%"
