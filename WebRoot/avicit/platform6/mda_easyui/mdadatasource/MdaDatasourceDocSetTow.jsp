...
<script type="text/javascript">
	...
	function saveForm() {
		...
		var type="2";
		$.ajax({
			 url:"platform/mdaDatasourceEasyUIController/operation/saveSetTow/doc/${tmpID}",
					         ...
					         <tr class="data">
				             		<c:forEach items="${parseFieldsArr }" var="field">
				                		 <td style="border: 1px solid gray;"><input readonly="readonly" value="${field}"  class="inputbox easyui-validatebox " type="text"  style="width: 100%;"  name="parseFieldNameList"  /></td>
			                    	 	 <input  class="inputbox easyui-validatebox" type="hidden" value=" "  style="width: 100%;"  name="parseFieldValueList"  />
				              		</c:forEach>
					          </tr>
			             </c:if>
					   </table>
					     ...
					     <%--   <c:if test="${!empty parseFields }">
					      ...
					      <c:if test="${empty parseFields }">
					       <c:if test="${!empty fieldsArr }">
					             ...
					             <tr class="data">
					                 <td style="border: 1px solid gray;"><input readonly="readonly" value="${field}"  class="inputbox easyui-validatebox " type="text"  style="width: 100%;"  name="indexFieldNameList"  /></td>
