...
<script src="avicit/platform6/mda_easyui/mdadatasource/js/MdaCrawlitems.js" type="text/javascript"></script>
<script type="text/javascript">
	...
	var selectMdaType;//分类选择框
	$(function(){
		selectMdaType = new SelectMdaType("formId", "classifyids");
		selectMdaType.init();
	...
	function saveForm(){
		...
		if(hasvalidate){
			...
			parent.mdaCrawlitems.save(serializeObject($('#form')),"#insert");
		}
	}
	...
	<div data-options="region:'center',split:true,border:false">
		<form id='form'>
			<input type="hidden" name="id" /> <input type="hidden"
				name="datasrcid" id="datasrcid" value='${pid}' />
			<table class="form_commonTable">
				<tr>
					<th width="10%"
						style="word-break: break-all; word-warp: break-word;"><span
						style="color: red;">*</span>采集任务:</th>
				...
				<tr>
					...
					<td width="39%"><input title="LASTCRAWLUSERID" class="inputbox" 
						...
						<div class="">
							<input class="easyui-validatebox" type="text" title="LASTCRAWLUSERID" value='<c:out  value='${mdaCrawlitemsDTO.lastcrawluseridAlias}'/>'
				...
				<tr>
					...
					<td width="39%"><input title="CLASSIFYIDS"
						class="inputbox easyui-validatebox" placeholder="请选择分类" readonly
						data-options="validType:'maxLength[50]'" style="width: 99%;"
						type="text" name="classifyids" id="classifyids" /></td>
					<th width="10%"
						style="word-break: break-all; word-warp: break-word;">
						状态:</th>
					<td width="39%"><pt6:syslookup name="status" id="status" defaultValue='1'
							title="zhuangtai" isNull="true" lookupCode="MDA_STATUS"
							dataOptions="editable:false,panelHeight:'auto',onShowPanel:comboboxOnShowPanel">
						</pt6:syslookup></td>
				</tr>
