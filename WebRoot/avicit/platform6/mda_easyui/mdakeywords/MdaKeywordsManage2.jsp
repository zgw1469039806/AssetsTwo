	...
	<div id="tableToolbar" class="toolbar">
		<div class="toolbar-left">
			<sec:accesscontrollist hasPermission="3"
				domainObject="formdialog_mdaKeywords_button_add" permissionDes="昨天">
				<a id="mdaSearchByYestady" href="javascript:void(0)"
					class="btn btn-primary form-tool-btn btn-sm" role="button"
					title="昨天"><i class="fa fa-plus"></i> 昨天</a>
			</sec:accesscontrollist>
			<sec:accesscontrollist hasPermission="3"
				domainObject="formdialog_mdaKeywords_button_add" permissionDes="今天">
				<a id="<!-- mdaKeywords_insert -->" href="javascript:void(0)"
					class="btn btn-primary form-tool-btn btn-sm" role="button"
					title="今天"><i class="fa fa-plus"></i> 今天</a>
			</sec:accesscontrollist>
			<sec:accesscontrollist hasPermission="3"
				domainObject="formdialog_mdaKeywords_button_add"
				permissionDes="最近7天">
				<a id="<!-- mdaKeywords_insert -->" href="javascript:void(0)"
					class="btn btn-primary form-tool-btn btn-sm" role="button"
					title="最近7天"><i class="fa fa-plus"></i> 最近7天</a>
			</sec:accesscontrollist>
			<sec:accesscontrollist hasPermission="3"
				domainObject="formdialog_mdaKeywords_button_add"
				permissionDes="最近30天">
				<a id=" " href="javascript:void(0)"
					class="btn btn-primary form-tool-btn btn-sm" role="button"
					title="最近30天"><i class="fa fa-plus"></i> 最近30天</a>
			</sec:accesscontrollist>
		...
		<div class="toolbar-right">
			<div class="input-group form-tool-search">
				<input type="text" name="keyWord" id="keyWord" style="width: 240px;"
					...
					id="mdaKeywords_searchPart"
					class="icon icon-search form-tool-searchicon"></label>
			</div>
			<div class="input-group-btn form-tool-searchbtn">
				<a id="mdaKeywords_searchAll" href="javascript:void(0)"
		...
		<table class="form_commonTable">
			<tr>
				...
				<td width="39%">
					<div class="input-group input-group-sm spinner"
						...
						<input title="" type="text" class="form-control" name="rate"
							id="rate" data-min="0" data-max="999999999999" data-step="1"
			...
			<tr>
				...
				<td width="39%">
					<div class="input-group input-group-sm spinner"
						data-trigger="spinner">
						<input title="" type="text" class="form-control" name="type"
							id="type" data-min="0" data-max="999999999999" data-step="1"
							data-precision="0"> <span class="input-group-addon">
							<a href="javascript:;" class="spin-up" data-spin="up"><i
								class="glyphicon glyphicon-triangle-top"></i></a> <a
							href="javascript:;" class="spin-down" data-spin="down"><i
				...
				<td width="39%">
					<div class="input-group input-group-sm">
						<input class="form-control date-picker" type="text"
							name="timeBegin" id="timeBegin" /> <span
			...
			<tr>
				...
				<td width="39%">
					<div class="input-group input-group-sm">
						<input class="form-control date-picker" type="text" name="timeEnd"
							id="timeEnd" /> <span class="input-group-addon"><i
							class="glyphicon glyphicon-calendar"></i></span>
					</div>
				</td>
			</tr>
...
<script src="avicit/platform6/mda_easyui/mdakeywords/js/MdaKeywords.js"
