	...
	<div data-options="region:'center',split:true,border:false">
		<form id='form'>
			<input type="hidden" name="version"
				value='<c:out  value='${mdaKeywordsDTO.version}'/>' /> <input
				type="hidden" name="id"
				value='<c:out  value='${mdaKeywordsDTO.id}'/>' />
			<table class="form_commonTable">
				<tr>
					<th width="10%"
						style="word-break: break-all; word-warp: break-word;"><label
						for="name">关键词:</label></th>
					<td width="39%"><input class="form-control input-sm"
						type="text" name="name" id="name"
						value='<c:out  value='${mdaKeywordsDTO.name}'/>' /></td>
					<th width="10%"
						style="word-break: break-all; word-warp: break-word;"><label
						for="rate">频率:</label></th>
					<td width="39%">
						<div class="input-group input-group-sm spinner"
							data-trigger="spinner">
							<input class="form-control" type="text" name="rate" id="rate"
								value='<c:out  value='${mdaKeywordsDTO.rate}'/>' data-min="0"
								data-max="999999999999" data-step="1" data-precision="0">
				...
				<tr>
					<th width="10%"
						style="word-break: break-all; word-warp: break-word;"><label
						for="type">类型:</label></th>
					<td width="39%">
						<div class="input-group input-group-sm spinner"
							data-trigger="spinner">
							<input class="form-control" type="text" name="type" id="type"
								value='<c:out  value='${mdaKeywordsDTO.type}'/>' data-min="0"
								data-max="999999999999" data-step="1" data-precision="0">
							<span class="input-group-addon"> <a href="javascript:;"
								class="spin-up" data-spin="up"><i
									class="glyphicon glyphicon-triangle-top"></i></a> <a
					...
					<th width="10%"
						style="word-break: break-all; word-warp: break-word;"><label
						for="time">时间:</label></th>
					<td width="39%">
						<div class="input-group input-group-sm">
							<input class="form-control date-picker" type="text" name="time"
								id="time"
								value='<fmt:formatDate pattern="yyyy-MM-dd" value='${mdaKeywordsDTO.time}'/>' /><span
			...
			<table class="tableForm"
				...
				<tr>
					<td width="50%" style="padding-right: 4%;" align="right"><a
						...
						title="保存" id="mdaKeywords_saveForm">保存</a> <a
						href="javascript:void(0)"
						class="btn btn-grey form-tool-btn btn-sm" role="button" title="返回"
						id="mdaKeywords_closeForm">返回</a></td>
				</tr>
			</table>
		</div>
	</div>
