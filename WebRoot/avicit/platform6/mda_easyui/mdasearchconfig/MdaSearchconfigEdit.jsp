...
<!-- ControllerPath = "train/demo/mdasearchconfig/mdaSearchconfigController/operation/Edit/id" -->
<title>修改</title>
...
<script type="text/javascript">
	...
	$(function() {
		if (!"${mdaSearchconfigDTO.createtime}" == "") {
			$('#createtime').datebox(
					'setValue',
					parserColumnTime("${mdaSearchconfigDTO.createtime}")
							.format("yyyy-MM-dd"));
		}
	...
	function saveForm() {
		...
		if (hasvalidate) {
			...
			parent.mdaSearchconfig.save(serializeObject($('#form')), "#edit");
		}
	}
	...
	<div data-options="region:'center',split:true,border:false">
		<form id='form'>
			<input type="hidden" name="version"
				value='<c:out  value='${mdaSearchconfigDTO.version}'/>' /> <input
				type="hidden" name="id"
				value='<c:out  value='${mdaSearchconfigDTO.id}'/>' />
