	...
	<div data-options="region:'center',split:true,border:false">
		<form id='form'>
			<table class="form_commonTable">
				...
				<tr>
					<th width="5%" style="word-break: break-all; word-warp: break-word;"><label for="oldpassword"><i class="required">*</i>原密码:</label></th>
					<td width="39%"><input title="密码" class="form-control input-sm" type="password" name="oldpassword" id="oldpassword" /></td>
				</tr>
				
				<tr>
					<th width="5%" style="word-break: break-all; word-warp: break-word;"><label for="password"><i class="required">*</i>新密码:</label></th>
					<td width="39%"><input title="新密码" class="form-control input-sm" type="password" name="password" id="password" /></td>
				</tr>
				<tr>
					<th width="5%" style="word-break: break-all; word-warp: break-word;"><label for="confirm_password"><i class="required">*</i>确认密码:</label></th>
