...
<style> 
.header,.content,.footer{margin:600 auto;width:100%; height:100px} 
/* 以上代码设置三个共用样式 */ 
.header{border:0px solid #F00;height:400px;margin-top: 100px} 
.content{ border:0px solid #FF0; height:400px} 
.footer{border:0px solid #00F;height:400px} 
</style> 
</head>
	...
	<script type="text/javascript">
		mxBasePath = '<%=ViewUtil.getRequestPath(request)%>'+'/console/org';
	</script>

	<!-- Loads and initializes the library -->
	<script type="text/javascript" src="avicit/platform6/console/org/js/mxClient.js"></script>
