		...
		<form id="form" fit="true">
			...
			<table class="form_commonTable">
				<tr>
                	...
                	<td width="40%">
                	    <select id="group" name="group" title="任务分组" class="form-control input-sm"></select>
                	</td>
	...
	<div data-options="region:'center'" split="false" collapsible="false" border="false">
	   ...
	   <div id="myTabContent" class="tab-content">
		 <div class="tab-pane fade in active" id="home">
			<iframe frameborder="0" id="paramifr" src="avicit/platform6/console/quartz/SysJobVariablesUpdate.jsp?masterId=${sysJobDTO.id}" style="height:260px;width:100%"  ></iframe>
		 </div>
		 <!-- 排除日期 -->
