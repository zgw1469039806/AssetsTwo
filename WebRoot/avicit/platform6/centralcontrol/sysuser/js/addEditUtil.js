...
function mySelectPos(){
	...
	userSelector.init(false,"selectPosDialogCallBack",1);
}
//岗位选择回调
...
function mySelectRole(){
	...
	userSelector.init(false,"selectRoleDialogCallBack",1);
}
//角色选择回调
...
function mySelectDept(){
	...
	deptSelector.init(false,"selectDeptDialogCallBack",'n',1);
}
//部门选择回调
