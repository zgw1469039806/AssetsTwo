    ...
    function n(a, e) {
        ...
        return {
            ...
            onOk: function() {
                ...
                if (b.info) {
                    b = b.info;
                    if (!this._.selectedElement) for (var h = c.append(l("tbody")), e = parseInt(b.txtRows, 10) || 0, f = parseInt(b.txtCols, 10) || 0, i = 0; i < e; i++) 
                    	for (var j = h.append(l("tr")), k = 0; k < f; k++) {
                    		var td = j.append(l("td"));
                    		$(td.$).on("dragenter",function(ev){
                    ...
                    c.setStyle("tableLayout","fixed");
                    c.setAttribute("id","edittable");
