...
SysProfile.prototype.insert=function(){
	this.nData = new CommonDialog("insert","700","430",'platform/sysprofile/operation/add/null',"添加",false,true,false);
	this.nData.show();
};
//关闭对话框
...
SysProfile.prototype.modify=function(){
	...
	this.eData = new CommonDialog("edit","700","430",'platform/sysprofile/operation/modify/'+rows[0].id,"编辑",false,true,false);
	this.eData.show();
};
//保存功能
