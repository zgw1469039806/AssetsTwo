...
<!-- ControllerPath = "platform6/mda/mdasearchstatistic/mdaSearchstatisticController/operation/Edit/id" -->
<title>修改</title>
...
<script type="text/javascript">
	...
	function closeForm(){
		parent.mdaSearchstatistic.closeDialog("#edit");
	}
	function saveForm(){
	    ...
	    if(hasvalidate){
		   ...
		   parent.mdaSearchstatistic.save(serializeObject($('#form')),"#edit");
		}
	}
...
<body class="easyui-layout" fit="true" style="visibility:hidden;">
	<div data-options="region:'center',split:true,border:false">
		<form id='form'>
						<input type="hidden" name="version" value='<c:out  value='${mdaSearchstatisticDTO.version}'/>'/>
															<input type="hidden" name="id" value='<c:out  value='${mdaSearchstatisticDTO.id}'/>'/>
					...
					<tr>
																...
																KEYWORDS:</th>
								 								   								     <td width="39%">
																											...
																											<input title="KEYWORDS" class="easyui-validatebox" data-options="required:true,validType:'maxLength[255]'" style="width: 99%;" type="text" name="keywords" id="keywords" value='<c:out value='${mdaSearchstatisticDTO.keywords}'/>'/>
																									</td>
																																																																			   														  <th width="10%" style="word-break:break-all;word-warp:break-word;">
							  																RATE:</th>
								 								   								    <td width="39%">
								   								 								
																									  		<input title="RATE" class="easyui-numberbox easyui-validatebox" data-options="validType:'maxLength[11]'" style="width: 99%;" type="text" name="rate" id="rate" value='<c:out  value='${mdaSearchstatisticDTO.rate}'/>'/>	
																									</td>
																	</tr>
									<tr>
																																																				</tr>
