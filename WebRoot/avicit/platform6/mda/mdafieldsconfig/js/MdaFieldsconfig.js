 ...
 * 
 */
function MdaFieldsconfig(datagrid,url,searchD,form,keyWordId,searchNames,dataGridColModel){
...
//初始化操作
MdaFieldsconfig.prototype.init=function(){
	var _self = this;
	$(_self._datagridId).jqGrid({
    	url: this.getUrl()+'getMdaFieldsconfigsByPage.json',
        mtype: 'POST',
        datatype: "json",
        toolbar: [true,'top'],
...
//添加页面
MdaFieldsconfig.prototype.insert=function(){
...
//编辑页面
MdaFieldsconfig.prototype.modify=function(){
...
//详细页
MdaFieldsconfig.prototype.detail=function(id){
...
//打开高级查询框
MdaFieldsconfig.prototype.openSearchForm = function(searchDiv){
	var _self = this;
...
MdaFieldsconfig.prototype.formValidate=function(form){
	form.validate({
		rules: {
						  		     			 		  				  				  				  				  				  				  				  				  		     			    				   					itemid:{
						maxlength: 32
...
//保存功能
MdaFieldsconfig.prototype.save=function(form,id){
	var _self = this;
	avicAjax.ajax({
...
//删除
MdaFieldsconfig.prototype.del=function(){
...
//重载数据
MdaFieldsconfig.prototype.reLoad=function(){
...
//关闭对话框
MdaFieldsconfig.prototype.closeDialog=function(id){
	if(id == "insert"){
...
//高级查询
MdaFieldsconfig.prototype.searchData =function(){
	var searchdata = {
			keyWord: null,
...
//关键字段查询
MdaFieldsconfig.prototype.searchByKeyWord =function(){
...
//隐藏查询框
MdaFieldsconfig.prototype.hideSearchForm =function(){
	layer.close(searchDialogindex);
};
/*清空查询条件*/
MdaFieldsconfig.prototype.clearData =function(){
