...
<body class="easyui-layout" fit="true">
	<div data-options="region:'center',split:true,border:false">
		<form id='form'>
				...
				<tr>
								    									...
								    									<td width="39%">
																		    <input class="form-control input-sm" type="text" name="itemid"  id="itemid" value='<c:out  value='${mdaFieldsconfigDTO.itemid}'/>'/>
																	   </td>
																																								   													 																			    																	<th width="10%" style="word-break:break-all;word-warp:break-word;">
								    								  	<label for="fieldname">FIELDNAME:</label></th>
								    									<td width="39%">
																		    <input class="form-control input-sm" type="text" name="fieldname"  id="fieldname" value='<c:out  value='${mdaFieldsconfigDTO.fieldname}'/>'/>
																	   </td>
																			</tr>
										<tr>
																																								   													 																			    																	<th width="10%" style="word-break:break-all;word-warp:break-word;">
								    									...
								    									<td width="39%">
																		    <input class="form-control input-sm" type="text" name="fieldvalue"  id="fieldvalue" value='<c:out  value='${mdaFieldsconfigDTO.fieldvalue}'/>'/>
																	   </td>
																																								   													 																			    																	<th width="10%" style="word-break:break-all;word-warp:break-word;">
								    								  	<label for="fieldtype">FIELDTYPE:</label></th>
								    									<td width="39%">
																		    <input class="form-control input-sm" type="text" name="fieldtype"  id="fieldtype" value='<c:out  value='${mdaFieldsconfigDTO.fieldtype}'/>'/>
																	   </td>
																			</tr>
										<tr>
																																								   													 						</tr>
	...
	<script type="text/javascript">
			function closeForm(){
			parent.mdaFieldsconfig.closeDialog("edit");
		}
		function saveForm(){
	        ...
	        if (!isValidate.checkForm()) {
			  ...
			  parent.mdaFieldsconfig.save($('#form'),"eidt");
		}
