              ...
              <tr class="data">
                <c:forEach items="${fieldlist}" var="field">
                  <td style="border: 1px solid gray;">
                   <input  class="form-control input-sm" type="text" value="${field }"  style="width: 100%;"  disabled name="parseFieldNameList" />
...
<script type="text/javascript">
  ...
  function saveForm() {
    ...
    $.ajax({
      url:"platform/platform6/mda/mdadatasource/mdaDatasourceController/operation/saveSetTow/db/${tmpID}",
      data : {
