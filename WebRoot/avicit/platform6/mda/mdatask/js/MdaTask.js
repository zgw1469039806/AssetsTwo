 ...
 * 
 */
function MdaTask(datagrid,url,searchD,form,keyWordId,searchNames,dataGridColModel){
...
//打开高级查询框
MdaTask.prototype.openSearchForm = function(searchDiv){
	var _self = this;
...
MdaTask.prototype.formValidate=function(form){
	form.validate({
		rules: {
						  		     			 		  				  				  				  				  				  				  				  				  		     			    				   					taskname:{
						maxlength: 255
...
//关键字段查询
MdaTask.prototype.searchByKeyWord =function(){
