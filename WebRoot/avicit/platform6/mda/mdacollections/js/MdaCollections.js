 ...
 * 
 */
function MdaCollections(datagrid,url,searchD,form,keyWordId,searchNames,dataGridColModel){
...
//添加页面
MdaCollections.prototype.insert=function(){
...
//编辑页面
MdaCollections.prototype.modify=function(){
...
//详细页
MdaCollections.prototype.detail=function(id){
...
//打开高级查询框
MdaCollections.prototype.openSearchForm = function(searchDiv){
	var _self = this;
...
//保存功能
MdaCollections.prototype.save=function(form,id){
	var _self = this;
	avicAjax.ajax({
...
//高级查询
MdaCollections.prototype.searchData =function(){
	var searchdata = {
			keyWord: null,
...
//隐藏查询框
MdaCollections.prototype.hideSearchForm =function(){
