...
<body class="easyui-layout" fit="true">
	<div data-options="region:'center',split:true,border:false">
		<form id='form'>
				...
				<tr>
								    								  	...
								    								  	<label for="name">配置名称:</label></th>
								    									<td width="39%">
																		    <input class="form-control input-sm" readonly="readonly" type="text" name="name"  id="name" value='<c:out  value='${mdaSearchconfigDTO.name}'/>'/>
																	   </td>
																																								   													 																			    																	<th width="10%" style="word-break:break-all;word-warp:break-word;">
								    								  	<label for="numbers">过滤级别:</label></th>
								    									<td width="39%">
																		  	<div class="input-group input-group-sm spinner" data-trigger="spinner">
										  <input  class="form-control"  type="text" name="numbers" id="numbers" value='<c:out  value='${mdaSearchconfigDTO.numbers}'/>' data-min="0" data-max="5" data-step="1" data-precision="0">
										...
										<tr>
								    									...
								    									<td width="39%">
																		    <input readonly="readonly" class="form-control input-sm" type="text" name="filtercontent"  id="filtercontent" value='<c:out  value='${mdaSearchconfigDTO.filtercontent}'/>'/>
																	   </td>
																																								   													 																			    																	<th width="10%" style="word-break:break-all;word-warp:break-word;">
								    								  	<label for="createtime">创建时间:</label></th>
								    									<td width="39%">
																		    <div class="input-group input-group-sm">
				                	      <input class="form-control date-picker" readonly="readonly" type="text" name="createtime" id="createtime" value='<fmt:formatDate pattern="yyyy-MM-dd" value='${mdaSearchconfigDTO.createtime}'/>'/><span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
				              	        </div>
																	   </td>
																			</tr>
										<tr>
	...
	<script type="text/javascript">
			function closeForm(){
			parent.mdaSearchconfig.closeDialog("edit");
		}
		function saveForm(){
	        ...
	        if (!isValidate.checkForm()) {
			  ...
			  parent.mdaSearchconfig.save($('#form'),"eidt");
		}
