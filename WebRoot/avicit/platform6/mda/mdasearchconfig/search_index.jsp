...
<body > 
<form:form id="f1" name="f1" modelAttribute="search" method="post" action="search.do" style="height:89%;" >
	   ...
	   <tr >
	    ...
	    <td align="center" width="100%">
		     <div style="height:15%;margin:35px;">
			    <table style="valign=top;border:none;height:100%">
		           <tr >	             
						<td >
							<img src="static/images/platform/mda/search_imgs/search_logo2.png" border="0" style="width: 487px; height: 163px;"  >			
						</td>	     	    
				  </tr>	
				</table>
			</div>
		 	 ...
		 	 <div style="height:20%;margin:35px;">
				<table style="valign=top;border:none;height:100%">
					<tr  style="height:45%;" >
						<td>
				          <div class="row" style="width:350px;left:38%; margin:0 0 0 0; position:absolute; top:43%;" >
								<div class="input-group  input-group-sm">
							      <input id="sousuo" name="word" class="form-control" placeholder="请输入关键字。。。" type="text" >
							      <span class="input-group-btn">
							        <button id="subok" class="btn btn-default ztree-search" type="button"  onclick="ok_onclick(document.f1)" ><span class="glyphicon glyphicon-search"><font style="margin:5px;" >搜索一下</font></font></font></span></button>
							      </span>
							    </div>
						   </div>
						</td>
