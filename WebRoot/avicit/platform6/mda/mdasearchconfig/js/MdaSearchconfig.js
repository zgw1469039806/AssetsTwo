 ...
 * 
 */
function MdaSearchconfig(datagrid,url,searchD,form,keyWordId,searchNames,dataGridColModel){
...
//打开高级查询框
MdaSearchconfig.prototype.openSearchForm = function(searchDiv){
	var _self = this;
...
MdaSearchconfig.prototype.formValidate=function(form){
	form.validate({
		rules: {
						  		     			 		  				  				  				  				  				  				  				  				  		     			    				   					name:{
						maxlength: 100
...
//关键字段查询
MdaSearchconfig.prototype.searchByKeyWord =function(){
