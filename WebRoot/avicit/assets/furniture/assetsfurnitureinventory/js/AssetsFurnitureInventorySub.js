function AssetsFurnitureInventorySub(datagrid, url, formSub, dataGridColModel, searchDialogSub, pid, searchSubNames, demoSubUser_KeyWord, isReload) {
 ...
 * 初始化操作
 */
AssetsFurnitureInventorySub.prototype.init = function (pid) {
    var _self = this;
    if (_self.isReload == "true") {
        $(_self._datagridId).jqGrid({
            // url: _self.getUrl() + 'getAssetsFurnitureInventorySub',
			url: _self.getUrl(),
			postData: {pid: _self.pid},
            mtype: 'POST',
            datatype: "json",
            toolbar: [true, 'top'],
            colModel: assetsFurnitureInventorySubGridColModel,
...
//禁止时间和日期格式手输
    ...
    _self.notnullFiled.push("furnitureId");
    _self.notnullFiledComment.push("家具ID");
    _self.lengthValidFiled.push("furnitureId");
    _self.lengthValidFiledSize.push(50);
    _self.lengthValidFiledComment.push("家具ID");
    ...
    _self.lengthValidFiled.push("furnitureName");
    _self.lengthValidFiledSize.push(50);
    _self.lengthValidFiledComment.push("家具名称");
    _self.lengthValidFiled.push("furnitureCategory");
    _self.lengthValidFiledSize.push(10);
    _self.lengthValidFiledComment.push("家具分类");
    ...
    _self.lengthValidFiled.push("furnitureState");
    _self.lengthValidFiledSize.push(10);
    _self.lengthValidFiledComment.push("家具状态");
...
AssetsFurnitureInventorySub.prototype.insert = function () {
    var _self = this;
 ...
 * @param
 */
AssetsFurnitureInventorySub.prototype.nullvalid = function (data, item, nullfiled, notnullFiledComment) {
    var msg = "";
 ...
 * @param
 */
AssetsFurnitureInventorySub.prototype.lengthvalid = function (data, item, lengthValidFiled, lengthValidFiledComment, lengthValidFiledSize) {
    var msg = "";
    $.each(data, function (i, dataitem) {
 ...
 * 长度和非空校验
 */
AssetsFurnitureInventorySub.prototype.valid = function () {
    debugger;
    var _self = this;
    $(_self._datagridId).jqGrid('endEditCell');
 ...
 * @param pid
 */
AssetsFurnitureInventorySub.prototype.save = function (pid) {
    var _self = this;
    _self.pid = pid;
    $(_self._datagridId).jqGrid('endEditCell');
    var data = $(_self._datagridId).jqGrid('getRowData');
 ...
 * 删除
 */
AssetsFurnitureInventorySub.prototype.del = function () {
    var _self = this;
    //删除之前结束单元格
    $(_self._datagridId).jqGrid('endEditCell');
    ...
    if (isAddRow && notAddRow) {
        ...
        $('#cb_assetsFurnitureInventorySub').click();
        return false;
    }
    if (l > 0) {
 ...
 * 重载数据
 */
AssetsFurnitureInventorySub.prototype.reLoad = function (pid) {
    if (pid != undefined) {
        this.pid = pid;
    }
    pid = this.pid;
 ...
 * 获取子表数据
 */
AssetsFurnitureInventorySub.prototype.getSubData = function () {
    var _self = this;
    $(_self._datagridId).jqGrid('endEditCell');
    var data = $(_self._datagridId).jqGrid('getRowData');
 ...
 * 关闭对话框
 */
AssetsFurnitureInventorySub.prototype.closeDialog = function (id) {
    if (id == "insert") {
 ...
 * 打开高级查询框
 */
AssetsFurnitureInventorySub.prototype.openSearchForm = function (searchDiv, par) {
    var _self = this;
    par = null;
    //if(!par) par = $(window);
 ...
 * 高级查询
 */
AssetsFurnitureInventorySub.prototype.searchData = function () {
 ...
 * 关键字段查询
 */
AssetsFurnitureInventorySub.prototype.searchByKeyWord = function () {
 ...
 * 隐藏查询框
 */
AssetsFurnitureInventorySub.prototype.hideSearchForm = function () {
    layer.close(searchDialogindex);
};
/**
 * 清空查询条件
 */
AssetsFurnitureInventorySub.prototype.clearData = function () {
