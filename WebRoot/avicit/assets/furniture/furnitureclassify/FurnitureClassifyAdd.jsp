...
<body class="easyui-layout" fit="true">
			...
			<table class="tableForm"
				...
				<tr>
					<td width="50%" style="padding-right: 4%;" align="right"><a
						...
						title="保存" id="furnitureClassify_saveForm">保存</a> <a
						href="javascript:void(0)"
						class="btn btn-grey form-tool-btn btn-sm" role="button" title="返回"
						id="furnitureClassify_closeForm">返回</a></td>
				</tr>
			</table>
		</div>
	</div>
	...
	<script type="text/javascript">
			function closeForm(){
			parent.furnitureClassify.closeDialog("insert");
		}
		function saveForm(){
			...
			parent.furnitureClassify.save($('#form'),"insert");
		}
