    ...
    <form id='form'>
        ...
        <table class="form_commonTable">
            <tr>
                ...
                <td width="39%">
                    <input class="form-control input-sm" type="text" name="name" id="name" readonly="readonly"
            ...
            <tr>
                ...
                <td width="39%">
                    <input class="form-control input-sm" type="text" name="itemNum" id="itemNum" readonly="readonly"
                ...
                <td width="39%">
                    <div class="input-group input-group-sm spinner" data-trigger="spinner">
                        <input class="form-control" type="text" name="sn" id="sn" readonly="readonly"
            ...
            <tr>
                ...
                <td width="39%">
                    <input class="form-control input-sm" type="text" name="fatherNum" id="fatherNum" readonly="readonly"
                           value="<c:out  value='${furnitureClassifyDTO.fatherNum}'/>"/>
                </td>
                <th width="10%" style="word-break:break-all;word-warp:break-word;">
                    <label for="isvalid">ISVALID:</label></th>
                <td width="39%">
                    <input class="form-control input-sm" type="text" name="isvalid" id="isvalid" readonly="readonly"
            ...
            <tr>
                ...
                <td width="39%">
                    <input class="form-control input-sm" type="text" name="treePath" id="treePath" readonly="readonly"
