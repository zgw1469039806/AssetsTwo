 ...
 *
 */
function FurnitureClassify(datagrid, url, searchD, form, keyWordId, searchNames, dataGridColModel) {
...
var deviceCategory = 'N';//设备类别全局变量

//初始化操作
FurnitureClassify.prototype.init = function () {
    var _self = this;
    $(_self._datagridId).jqGrid({
        url: this.getUrl() + 'getFurnitureClassifysByPage.json',
        mtype: 'POST',
        datatype: "json",
        toolbar: [true, 'top'],
...
//添加页面
FurnitureClassify.prototype.insert = function () {
...
//编辑页面
FurnitureClassify.prototype.modify = function () {
...
//详细页
FurnitureClassify.prototype.detail = function (id) {
...
//打开高级查询框
FurnitureClassify.prototype.openSearchForm = function (searchDiv) {
    var _self = this;
...
FurnitureClassify.prototype.formValidate = function (form) {
    form.validate({
        rules: {
            parentid: {
                maxlength: 64
...
//保存功能
FurnitureClassify.prototype.save = function (form, id) {
    var _self = this;
    avicAjax.ajax({
...
//删除
FurnitureClassify.prototype.del = function () {
...
//重载数据
FurnitureClassify.prototype.reLoad = function () {
...
//关闭对话框
FurnitureClassify.prototype.closeDialog = function (id) {
    if (id == "insert") {
...
//高级查询
FurnitureClassify.prototype.searchData = function () {
    var searchdata = {
        keyWord: null,
...
//关键字段查询
FurnitureClassify.prototype.searchByKeyWord = function () {
...
//隐藏查询框
FurnitureClassify.prototype.hideSearchForm = function () {
    layer.close(searchDialogindex);
};
/*清空查询条件*/
FurnitureClassify.prototype.clearData = function () {
