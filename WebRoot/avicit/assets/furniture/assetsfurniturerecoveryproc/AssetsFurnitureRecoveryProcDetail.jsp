...
<html>
<head>
    <!-- ControllerPath = "assets/furniture/assetsfurniturerecoveryproc/assetsFurnitureRecoveryProcController/operation/toDetailJsp" -->
                        ...
                        <form id='form'>
                            ...
                            <table class="form_commonTable">
                                ...
                                <tr>
                                    ...
                                    <td width="15%">
                                        <textarea class="form-control input-sm" rows="3" name="recoveryReason"
                                                  id="recoveryReason"></textarea>
                                    </td>
                                    <th width="10%">
                                        <label for="handleSuggest">处理建议:</label></th>
                                    <td width="15%">
                                        <textarea class="form-control input-sm" rows="3" name="handleSuggest"
                                        ...
                                        <div id="toolbar_AssetsFurnitureRecoverySub" class="toolbar">
                                            <div class="toolbar-left">
                                                <sec:accesscontrollist hasPermission="3"
                                                                       domainObject="formdialog_AssetsFurnitureRecoverySub_button_add"
                                                                       permissionDes="添加">
                                                    <a id="assetsFurnitureRecoverySub_insert" href="javascript:void(0)"
                                                       class="btn btn-default form-tool-btn btn-sm bpm_self_class"
                                                       role="button"
                                                       title="添加"><i class="fa fa-plus"></i> 添加</a>
                                                </sec:accesscontrollist>
                                                <sec:accesscontrollist hasPermission="3"
                                                                       domainObject="formdialog_AssetsFurnitureRecoverySub_button_delete"
                                                                       permissionDes="删除">
                                                    <a id="assetsFurnitureRecoverySub_del" href="javascript:void(0)"
                                                       class="btn btn-default form-tool-btn btn-sm bpm_self_class"
                                                       role="button"
                                                ...
                                                <a class="btn btn-default form-tool-btn btn-sm bpm_self_class"
                                                   ...
                                                   name="assetsFurnitureRecoverySub_editable"
                                                   id="assetsFurnitureRecoverySub_editable">是否可编辑</a>
                                            </div>
                                        </div>
                                        <table id="assetsFurnitureRecoverySub" name="ASSETS_FURNITURE_RECOVERY_SUB"
                                               class="customform_subtable_bpm_auth"></table>
                                        <pt6:h5resource label="统一编号" name="unifiedId"
                                                        ref_table="ASSETS_FURNITURE_RECOVERY_SUB"></pt6:h5resource>
...
<script type="text/javascript"
        src="avicit/assets/furniture/assetsfurniturerecoveryproc/js/AssetsFurnitureRecoveryProcDetail.js"></script>
<script type="text/javascript"
        src="avicit/assets/furniture/assetsfurniturerecoveryproc/js/AssetsFurnitureRecoverySub.js"></script>
<script type="text/javascript">
    //后台获取的通用代码数据
    ...
    function initOnceInAdd() {
        avicAjax.ajax({
            url: "platform/assets/furniture/assetsfurniturerecoveryproc/assetsFurnitureRecoveryProcController/getLookUpCode",
            type: 'post',
            dataType: 'json',
            async: false,
            success: function (r) {
    ...
    var assetsFurnitureRecoverySubGridColModel = null;
    $(document).ready(function () {
        ...
        var assetsFurnitureRecoverySub = new AssetsFurnitureRecoverySub('assetsFurnitureRecoverySub', surl,
            "formSub",
            assetsFurnitureRecoverySubGridColModel,
            'searchDialogSub', pid, searchSubNames, 'assetsFurnitureRecoverySub_keyWord', isReload);
        //创建业务操作JS
        var assetsFurnitureRecoveryProcDetail = new AssetsFurnitureRecoveryProcDetail('form', assetsFurnitureRecoverySub);
        //创建流程操作JS
        new FlowEditor(assetsFurnitureRecoveryProcDetail);
        ...
        //绑定表单验证规则
        assetsFurnitureRecoveryProcDetail.formValidate($('#form'));
        //初始化附件上传组件
        ...
        //添加按钮绑定事件
        $('#assetsFurnitureRecoverySub_insert').bind('click', function () {
            assetsFurnitureRecoverySub.insert();
        });
        //删除按钮绑定事件
        $('#assetsFurnitureRecoverySub_del').bind('click', function () {
            assetsFurnitureRecoverySub.del();
        });
