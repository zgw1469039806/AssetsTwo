...
<html>
<head>
    <!-- ControllerPath = "assets/furniture/assetsfurnituretransferproc/assetsFurnitureTransferProcController/operation/toDetailJsp" -->
                        ...
                        <form id='form'>
                            ...
                            <table class="form_commonTable">
                                ...
                                <tr>
                                    ...
                                    <td width="15%">
                                        <input class="form-control input-sm" type="text" name="receiverByTel"
                                               id="receiverByTel"/>
                                    </td>
                                    <th width="10%">
                                    ...
                                    <td width="15%">
                                        <textarea class="form-control input-sm" rows="3" name="transferReason"
                                                  id="transferReason"></textarea>
                                    </td>
                                    <th width="10%">
                                        <label for="furnitureCondition">家具完好情况:</label></th>
                                    <td width="15%">
                                        <textarea class="form-control input-sm" rows="3" name="furnitureCondition"
                                ...
                                <tr>
                                    ...
                                    <td width="15%">
                                        <textarea class="form-control input-sm" rows="3" name="furnitureAppendix"
                                        ...
                                        <div id="toolbar_AssetsFurnitureTransferSub" class="toolbar">
                                            <div class="toolbar-left">
                                                ...
                                                <a class="btn btn-default form-tool-btn btn-sm bpm_self_class"
                                                   ...
                                                   name="assetsFurnitureTransferSub_editable"
                                                   id="assetsFurnitureTransferSub_editable">是否可编辑</a>
                                            </div>
                                        </div>
                                        <table id="assetsFurnitureTransferSub" name="ASSETS_FURNITURE_TRANSFER_SUB"
                                               class="customform_subtable_bpm_auth"></table>
                                        <pt6:h5resource label="统一编号" name="unifiedId"
                                                        ref_table="ASSETS_FURNITURE_TRANSFER_SUB"></pt6:h5resource>
...
<script type="text/javascript"
        src="avicit/assets/furniture/assetsfurnituretransferproc/js/AssetsFurnitureTransferProcDetail.js"></script>
<script type="text/javascript"
...
<script type="text/javascript">
    ...
    function initOnceInAdd() {
        avicAjax.ajax({
            url: "platform/assets/furniture/assetsfurnituretransferproc/assetsFurnitureTransferProcController/getLookUpCode",
            type: 'post',
            dataType: 'json',
            async: false,
            success: function (r) {
    ...
    var assetsFurnitureTransferSubGridColModel = null;
    $(document).ready(function () {
        ...
        var assetsFurnitureTransferSub = new AssetsFurnitureTransferSub('assetsFurnitureTransferSub', surl,
            "formSub",
            assetsFurnitureTransferSubGridColModel,
            'searchDialogSub', pid, searchSubNames, 'assetsFurnitureTransferSub_keyWord', isReload);
        //创建业务操作JS
        var assetsFurnitureTransferProcDetail = new AssetsFurnitureTransferProcDetail('form', assetsFurnitureTransferSub);
        //创建流程操作JS
        new FlowEditor(assetsFurnitureTransferProcDetail);
        ...
        //绑定表单验证规则
        assetsFurnitureTransferProcDetail.formValidate($('#form'));
        //初始化附件上传组件
