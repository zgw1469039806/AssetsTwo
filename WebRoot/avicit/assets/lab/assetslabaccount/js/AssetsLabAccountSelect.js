...
AssetsLabAccount.prototype.init = function () {
    ...
    $(_self._datagridId).jqGrid({
        url: 'platform/assets/lab/assetslabaccount/assetsLabAccountController/operation/getAssetsLabAccountsByPage.json',
        mtype: 'POST',
        datatype: "json",
        toolbar: [true, 'top'],
...
function rowClick(rowId, _self) {
    ...
    if (rowId != "") {
        avicAjax.ajax({
            url: 'platform/assets/lab/assetslabaccount/assetsLabAccountController/operation/getLabAccountDetail',
            type: 'POST',
            async: true,
            dataType: 'json',
