 ...
 */
function AssetsDeviceAccCheck(datagrid, url, searchDialogId, form, keyWordId, searchNames, dataGridColModel) {
 ...
 * 初始化操作
 */
AssetsDeviceAccCheck.prototype.init = function () {
    var _self = this;
    ...
    $(_self._datagridId).jqGrid({
        ...
        height: 200,//初始化表格高度        scrollOffset: 20, //设置垂直滚动条宽度
        rowNum: 20,//每页条数
    ...
    $(this._datagridId).setColProp("deviceCategoryName",{editable:false});
    $(this._datagridId).setColProp("deviceModel",{editable:false});
    $(this._datagridId).setColProp("positionId",{editable:false});
    $(this._datagridId).setColProp("productDate",{editable:false});
    $(this._datagridId).setColProp("productArea",{editable:false});
    $(this._datagridId).setColProp("userIdAlias",{editable:false});
    $(this._datagridId).setColProp("userDeptAlias",{editable:false});
    $(this._datagridId).setColProp("lastAccCheckDate",{editable:false});
    $(this._datagridId).setColProp("accCheckCycle",{editable:false});
    $(this._datagridId).setColProp("nextAccCheckDate",{editable:false});
...
AssetsDeviceAccCheck.prototype.insert = function () {
    var _self = this;
    ...
    var newRowDeviceData = {
        ...
        "productDate":formatDate(deviceAccountDataObj.productDate),
        "productArea":deviceAccountDataObj.manufacturerId,//生产厂家给产地字段（前台显示生产厂家）
        "userId":deviceAccountDataObj.userId,
        "userIdAlias":deviceAccountDataObj.userIdAlias,
        "userDept":deviceAccountDataObj.userDept,
        "userDeptAlias":deviceAccountDataObj.userDeptAlias
    };
debugger;
 ...
 * @param
 */
AssetsDeviceAccCheck.prototype.nullvalid = function (data, item, nullfiled, notnullFiledComment) {
    var msg = "";
 ...
 * @param
 */
AssetsDeviceAccCheck.prototype.lengthvalid = function (data, item, lengthValidFiled, lengthValidFiledComment, lengthValidFiledSize) {
    var msg = "";
    $.each(data, function (i, dataitem) {
 ...
 * @param callback
 */
AssetsDeviceAccCheck.prototype.save = function () {
    var _self = this;
    var $info = $(_self._datagridId).jqGrid('endEditCell');
    if ($info[0].flag) {
        layer.alert("非法含有JS脚本完整标签");
 ...
 * 编辑
 */
AssetsDeviceAccCheck.prototype.edit = function () {
    var _self = this;
 ...
 * @param id
 */
AssetsDeviceAccCheck.prototype.detail = function (id) {
 ...
 * 删除
 */
AssetsDeviceAccCheck.prototype.del = function () {
    var _self = this;
    var rows = $(_self._datagridId).jqGrid('getGridParam', 'selarrrow');
    var ids = [];
    var l = rows.length;
 ...
 * 重载数据
 */
AssetsDeviceAccCheck.prototype.reLoad = function () {
    /*获取session的筛选数据-begin*/
    var deviceAccountData = sessionStorage.getItem("deviceAccountData");
    var deviceAccountDataObj = JSON.parse(deviceAccountData);
    if(sessionStorage.getItem("deviceAccountData")!=""){
 ...
 */
AssetsDeviceAccCheck.prototype.openSearchForm = function (searchDiv) {
    var _self = this;
 ...
 * 高级查询
 */
AssetsDeviceAccCheck.prototype.searchData = function () {
 ...
 * 关键字查询
 */
AssetsDeviceAccCheck.prototype.searchByKeyWord = function () {
 ...
 * 设置单元格可编辑
 */
AssetsDeviceAccCheck.prototype.setColEditable = function (rowid) {
    if(rowid != "" && rowid != undefined && rowid != null )
    {
        //设置单元格背景颜色-begin
        $(this._datagridId).jqGrid('setCell', rowid, 'lastAccCheckDate', '', {'background-color': '#ffffff'});
        $(this._datagridId).jqGrid('setCell', rowid, 'accCheckCycle', '', {'background-color': '#ffffff'});
        $(this._datagridId).jqGrid('setCell', rowid, 'nextAccCheckDate', '', {'background-color': '#ffffff'});
        $(this._datagridId).jqGrid('setCell', rowid, 'attachment', '', {'background-color': '#ffffff'});
        //设置单元格背景颜色-end
    }
    //设置单元格可编辑-begin
    $(this._datagridId).setColProp("lastAccCheckDate",{editable:true});
    $(this._datagridId).setColProp("accCheckCycle",{editable:true});
    $(this._datagridId).setColProp("nextAccCheckDate",{editable:true});
 ...
 * 设置单元格不可编辑
 */
AssetsDeviceAccCheck.prototype.setColUnEditable = function () {
    //设置单元格不可编辑-begin
    $(this._datagridId).setColProp("lastAccCheckDate",{editable:false});
    $(this._datagridId).setColProp("accCheckCycle",{editable:false});
    $(this._datagridId).setColProp("nextAccCheckDate",{editable:false});
