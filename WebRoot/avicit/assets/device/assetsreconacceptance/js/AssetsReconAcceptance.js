 ...
 */
function AssetsReconAcceptance(datagrid,url,searchD,form,keyWordId,searchNames,dataGridColModel){
    ...
    this._formCode = "reconAcceptance"; //表单的code，启动流程时需要
 ...
 * 初始化操作
 */
AssetsReconAcceptance.prototype.init=function(){
	var _self = this;
	//初始化流程帮助类
	flowListEditor = new FlowListEditor(this._formCode);
	$(_self._datagridId).jqGrid({
    	url: _self.getUrl()+'getAssetsReconAcceptancesByPage.json',
        mtype: 'POST',
        datatype: "json",
 ...
 * 添加页面
 */
AssetsReconAcceptance.prototype.insert=function(){
	//添加流程
 ...
 * 编辑页面
 */
AssetsReconAcceptance.prototype.modify=function(){
 ...
 * 详情页面
 */
AssetsReconAcceptance.prototype.detail=function(id,value){
	flowUtils.detail(id);
};
/**
 * 打开高级查询框
 */
AssetsReconAcceptance.prototype.openSearchForm = function(searchBtn, contentWidth, contentHeight){
	var _self = this;
	var _resizeFunc;
 ...
 */
AssetsReconAcceptance.prototype.formValidate=function(form){
	form.validate({
		rules: {
						  		     			 		  				  		     			    				   					acceptanceNo:{
						maxlength: 50
 ...
 * 保存方法
 */
AssetsReconAcceptance.prototype.save=function(form,windowName,callback){
	var _self = this;
	avicAjax.ajax({
 ...
 * 删除方法
 */
AssetsReconAcceptance.prototype.del=function(){
	var _self = this;
 ...
 * 重载数据
 */
AssetsReconAcceptance.prototype.reLoad=function(){
	var searchdata = {
		keyWord: null,
 ...
 * 关闭对话框
 */
AssetsReconAcceptance.prototype.closeDialog=function(windowName, msg){
	layer.close(layer.getFrameIndex(windowName));
	if(msg && msg !== ''){
		layer.msg(msg);
	}
 ...
 * 后台查询	
 */
AssetsReconAcceptance.prototype.searchData =function(){
 ...
 * 关键字段查询
 */
AssetsReconAcceptance.prototype.searchByKeyWord =function(){
 ...
 * 根据流程状态查询
 */
AssetsReconAcceptance.prototype.initWorkFlow = function(status){
	$('#bpmState').val(status);
	if(status == "start"){
		$("#assetsReconAcceptance_modify").show();
		$("#assetsReconAcceptance_del").show();
	}else{
		$("#assetsReconAcceptance_modify").hide();
		$("#assetsReconAcceptance_del").hide();
	}
	this.searchData();
};
/**
 * 清空查询条件
 */
AssetsReconAcceptance.prototype.clearData =function(){
