    ...
    <form id='form'>
        ...
        <table class="form_commonTable">
            ...
            <tr>
                ...
                <td width="15%">
                    <input class="form-control input-sm" type="text" name="orignEquipSituation"
                           id="orignEquipSituation"/>
                </td>
                <th width="10%">
                    <label for="efficiencySituation">使用效率情况:</label></th>
                <td width="15%">
                    <input class="form-control input-sm" type="text" name="efficiencySituation"
            ...
            <tr>
                ...
                <td width="15%">
                    <input class="form-control input-sm" type="text" name="meteringRequirement"
...
<script type="text/javascript">
    function closeForm() {
        parent.assetsUstdtempapplyCollect.closeDialog("insert");
    }
