    ...
    <form id='form'>
        ...
        <table class="form_commonTable">
            <tr>
                ...
                <td width="15%">
                    <input class="form-control input-sm" type="text" name="assetId" id="assetId" disabled="disabled"
                           value="<c:out  value='${assetsDeviceAccountDTO.assetId}'/>"/>
                </td>
                <th width="10%" style="word-break:break-all;word-warp:break-word;">
                    <label for="unifiedId">统一编号:</label></th>
                <td width="15%">
                    <input class="form-control input-sm" type="text" name="unifiedId" id="unifiedId" disabled="disabled"
                ...
                <td width="15%">
                    <input class="form-control input-sm" type="text" name="deviceName" id="deviceName"
                           value="<c:out  value='${assetsDeviceAccountDTO.deviceName}'/>"/>
                </td>
            </tr>
            <tr>
                <th width="10%" style="word-break:break-all;word-warp:break-word;">
                ...
                <td width="15%">
                    <div class="input-group  input-group-sm">
                        ...
                        <input class="form-control" placeholder="请选择用户" type="text" id="ownerIdAlias"
                               name="ownerIdAlias" value="<c:out  value='${assetsDeviceAccountDTO.ownerIdAlias}'/>">
                ...
                <td width="15%">
                    <div class="input-group  input-group-sm">
                        ...
                        <input class="form-control" placeholder="请选择部门" type="text" id="ownerDeptAlias"
                               name="ownerDeptAlias" value="<c:out  value='${assetsDeviceAccountDTO.ownerDeptAlias}'/>">
                        <span class="input-group-addon">
            ...
            <tr>
                ...
                <td width="15%">
                    <div class="input-group  input-group-sm">
                        ...
                        <input class="form-control" placeholder="请选择用户" type="text" id="userIdAlias" name="userIdAlias"
                               value="<c:out  value='${assetsDeviceAccountDTO.userIdAlias}'/>">
                        <span class="input-group-addon">
							                     <i class="glyphicon glyphicon-user"></i>
							                   </span>
                    </div>
                ...
                <td width="15%">
                    <div class="input-group  input-group-sm">
                        ...
                        <input class="form-control" placeholder="请选择部门" type="text" id="userDeptAlias"
                               name="userDeptAlias" value="<c:out  value='${assetsDeviceAccountDTO.userDeptAlias}'/>">
                        <span class="input-group-addon">
									        <i class="glyphicon glyphicon-equalizer"></i>
									      </span>
                    </div>
                ...
                <td width="15%">
                    <input class="form-control input-sm" type="text" name="manufacturerId" id="manufacturerId"
                           value="<c:out  value='${assetsDeviceAccountDTO.manufacturerId}'/>"/>
                </td>
                <th width="10%" style="word-break:break-all;word-warp:break-word;">
            ...
            <tr>
                ...
                <td width="15%">
                    <pt6:h5select css_class="form-control input-sm" name="isManage" id="isManage" title="" isNull="true"
                                  lookupCode="PLATFORM_YES_NO_FLAG" defaultValue='${assetsDeviceAccountDTO.isManage}'/>
                </td>
                <th width="10%" style="word-break:break-all;word-warp:break-word;">
            ...
            <tr>
                ...
                <td width="15%">
                    <input class="form-control input-sm" type="text" name="productCountry" id="productCountry"
                           value="<c:out  value='${assetsDeviceAccountDTO.productCountry}'/>"/>
                </td>
            </tr>
            <tr>
                <th width="10%" style="word-break:break-all;word-warp:break-word;">
                ...
                <td width="15%">
                    <input class="form-control input-sm" type="text" name="productFactory" id="productFactory"
                           value="<c:out  value='${assetsDeviceAccountDTO.productFactory}'/>"/>
                </td>
                <th width="10%" style="word-break:break-all;word-warp:break-word;">
                ...
                <td width="15%">
                    <input class="form-control input-sm" type="text" name="productNum" id="productNum"
                           value="<c:out  value='${assetsDeviceAccountDTO.productNum}'/>"/>
                </td>
            </tr>
            <tr>
                <th width="10%" style="word-break:break-all;word-warp:break-word;">
            ...
            <tr>
                ...
                <td width="15%">
                    <input class="form-control input-sm" type="text" name="improveProject" id="improveProject"
                           value="<c:out  value='${assetsDeviceAccountDTO.improveProject}'/>"/>
                </td>
                <th width="10%" style="word-break:break-all;word-warp:break-word;">
            ...
            <tr>
                ...
                <td width="15%">
                    <input class="form-control input-sm" type="text" name="carFrameNum" id="carFrameNum"
                           value="<c:out  value='${assetsDeviceAccountDTO.carFrameNum}'/>"/>
                </td>
                <th width="10%" style="word-break:break-all;word-warp:break-word;">
            ...
            <tr>
                ...
                <td width="15%">
                    <div class="input-group input-group-sm">
                        <input class="form-control date-picker" type="text" name="stateChangeDate" id="stateChangeDate"
                ...
                <td width="15%">
                    <input class="form-control input-sm" type="text" name="deviceSysName" id="deviceSysName"
                           value="<c:out  value='${assetsDeviceAccountDTO.deviceSysName}'/>"/>
                </td>
            </tr>
            <tr>
                <th width="10%" style="word-break:break-all;word-warp:break-word;">
            ...
            <tr>
                ...
                <td width="15%">
                    <input class="form-control input-sm" type="text" name="softwareNum" id="softwareNum"
                           value="<c:out  value='${assetsDeviceAccountDTO.softwareNum}'/>"/>
                </td>
            ...
            <tr>
                ...
                <th width="10%" style="word-break:break-all;word-warp:break-word;">
                    <label for="totalBorrow">质保期:</label></th>
                <td width="15%">
                    <div class="input-group input-group-sm spinner" data-trigger="spinner">
                ...
                <th width="10%" style="word-break:break-all;word-warp:break-word;">
                    <label for="stateChangeDate">质保截止日期:</label></th>
                <td width="15%">
                    <div class="input-group input-group-sm">
            ...
            <div role="tabpanel" class="tab-pane active" contenteditable="false" id="FinanceInfo" style="height: 100%; min-height: 40px;">
                <table class="form_commonTable">
                    <tr>
                        ...
                        <td width="15%">
                            <pt6:h5select css_class="form-control input-sm" name="assetsFinanceType" id="assetsFinanceType" style=""
                    ...
                    <tr>
                        ...
                        <td width="15%">
                            <input class="form-control input-sm" type="text" name="meteringId" id="meteringId"
                                   value="<c:out  value='${assetsDeviceAccountDTO.meteringId}'/>"/>
                        </td>
                        <th width="10%" style="word-break:break-all;word-warp:break-word;">
                        ...
                        <td width="15%">
                            <div class="input-group input-group-sm spinner" data-trigger="spinner">
                                <input class="form-control" type="text" name="meteringCycle" id="meteringCycle"
                                        value="<c:out  value='${assetsDeviceAccountDTO.meteringCycle}'/>"
                                       data-min="-<%=Math.pow(10,12)-Math.pow(10,-0)%>"
                                       data-max="<%=Math.pow(10,12)-Math.pow(10,-0)%>" data-step="1" data-precision="0">
                                <span class="input-group-addon">
											    <a href="javascript:;" class="spin-up" data-spin="up"><i
...
<script type="text/javascript">
    function closeForm() {
        parent.assetsDeviceAccount.closeDialog("edit");
    }
    ...
    function saveForm() {
        ...
        parent.assetsDeviceAccount.save($('#form'), "eidt");
    }
