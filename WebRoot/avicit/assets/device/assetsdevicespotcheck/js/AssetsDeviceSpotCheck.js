 ...
 */
function AssetsDeviceSpotCheck(datagrid, url, searchDialogId, form, keyWordId, searchNames, dataGridColModel) {
 ...
 * 初始化操作
 */
AssetsDeviceSpotCheck.prototype.init = function () {
    var _self = this;
    ...
    $(_self._datagridId).jqGrid({
        url: _self.getUrl() + 'getAssetsDeviceSpotChecksByPage.json',
        mtype: 'POST',
    ...
    _self.lengthValidFiled.push("spotCheckNum");
    _self.lengthValidFiledSize.push(50);
    _self.lengthValidFiledComment.push("点检基准书编号");
    _self.lengthValidFiled.push("spotCheckItem");
    _self.lengthValidFiledSize.push(50);
    _self.lengthValidFiledComment.push("点检项目");
    _self.lengthValidFiled.push("dataItem");
    _self.lengthValidFiledSize.push(50);
    _self.lengthValidFiledComment.push("数据项目");
    ...
    $(_self._datagridId).setColProp("spotCheckNum",{editable:false});
    $(_self._datagridId).setColProp("spotCheckItem",{editable:false});
    $(_self._datagridId).setColProp("dataItem",{editable:false});
...
AssetsDeviceSpotCheck.prototype.insert = function () {
    var _self = this;
 ...
 * @param
 */
AssetsDeviceSpotCheck.prototype.nullvalid = function (data, item, nullfiled, notnullFiledComment) {
    var msg = "";
 ...
 * @param
 */
AssetsDeviceSpotCheck.prototype.lengthvalid = function (data, item, lengthValidFiled, lengthValidFiledComment, lengthValidFiledSize) {
    var msg = "";
    $.each(data, function (i, dataitem) {
 ...
 * @param callback
 */
AssetsDeviceSpotCheck.prototype.save = function () {
    var _self = this;
    var $info = $(_self._datagridId).jqGrid('endEditCell');
    if ($info[0].flag) {
        layer.alert("非法含有JS脚本完整标签");
 ...
 * 编辑
 */
AssetsDeviceSpotCheck.prototype.edit = function () {
    var _self = this;
 ...
 * @param id
 */
AssetsDeviceSpotCheck.prototype.detail = function (id) {
 ...
 * 删除
 */
AssetsDeviceSpotCheck.prototype.del = function () {
    var _self = this;
    var rows = $(_self._datagridId).jqGrid('getGridParam', 'selarrrow');
    var ids = [];
    var l = rows.length;
 ...
 * 重载数据
 */
AssetsDeviceSpotCheck.prototype.reLoad = function () {
    /*获取session的筛选数据-begin*/
    var deviceAccountData = sessionStorage.getItem("deviceAccountData");
    var deviceAccountDataObj = JSON.parse(deviceAccountData);
    if(sessionStorage.getItem("deviceAccountData")!=""){
 ...
 */
AssetsDeviceSpotCheck.prototype.openSearchForm = function (searchDiv) {
    var _self = this;
 ...
 * 高级查询
 */
AssetsDeviceSpotCheck.prototype.searchData = function () {
 ...
 * 关键字查询
 */
AssetsDeviceSpotCheck.prototype.searchByKeyWord = function () {
 ...
 * 设置单元格可编辑
 */
AssetsDeviceSpotCheck.prototype.setColEditable = function (rowid) {
    if(rowid != "" && rowid != undefined && rowid != null )
    {
        //设置单元格背景颜色-begin
        $(this._datagridId).jqGrid('setCell', rowid, 'spotCheckNum', '', {'background-color': '#ffffff'});
        $(this._datagridId).jqGrid('setCell', rowid, 'spotCheckItem', '', {'background-color': '#ffffff'});
        $(this._datagridId).jqGrid('setCell', rowid, 'dataItem', '', {'background-color': '#ffffff'});
        $(this._datagridId).jqGrid('setCell', rowid, 'attachment', '', {'background-color': '#ffffff'});
        //设置单元格背景颜色-end
    }
    //设置单元格可编辑-begin
    $(this._datagridId).setColProp("spotCheckNum",{editable:true});
    $(this._datagridId).setColProp("spotCheckItem",{editable:true});
    $(this._datagridId).setColProp("dataItem",{editable:true});
 ...
 * 设置单元格不可编辑
 */
AssetsDeviceSpotCheck.prototype.setColUnEditable = function () {
    //设置单元格不可编辑-begin
    $(this._datagridId).setColProp("spotCheckNum",{editable:false});
    $(this._datagridId).setColProp("spotCheckItem",{editable:false});
    $(this._datagridId).setColProp("dataItem",{editable:false});
