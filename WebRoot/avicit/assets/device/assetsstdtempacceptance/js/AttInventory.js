function AttInventory(datagrid, url, formSub, dataGridColModel,searchDialogSub, pid, searchSubNames, demoSubUser_KeyWord, isReload){
 ...
 * 初始化操作
 */
AttInventory.prototype.init=function(pid){
	var _self = this;
	if(_self.isReload == "true"){
			$(_self._datagridId).jqGrid({
			url: _self.getUrl()+'getAttInventory',
	    	postData : {pid : _self.pid},
	        mtype: 'POST',
	        datatype: "json",
	        toolbar: [true,'top'],
	        colModel: attInventoryGridColModel, 
...
//禁止时间和日期格式手输
	...
	//初始化校验字段
				      ...
				      _self.lengthValidFiledComment.push("DEVICE_MODEL");
				     				    															   					     				      _self.lengthValidFiled.push("deviceName");
				      _self.lengthValidFiledSize.push(50);
				      _self.lengthValidFiledComment.push("DEVICE_NAME");
				     				    																					   					     				      _self.lengthValidFiled.push("deviceCategory");
				      _self.lengthValidFiledSize.push(50);
				      _self.lengthValidFiledComment.push("DEVICE_CATEGORY");
				     				    																											   					     				      _self.lengthValidFiled.push("deviceSpec");
				      _self.lengthValidFiledSize.push(50);
				      _self.lengthValidFiledComment.push("DEVICE_SPEC");
				     				    															   					     				      _self.lengthValidFiled.push("deviceNum");
				      _self.lengthValidFiledSize.push(50);
				      _self.lengthValidFiledComment.push("DEVICE_NUM");
				     				    															   					     				      _self.lengthValidFiled.push("fkSubColId");
				      _self.lengthValidFiledSize.push(50);
				      _self.lengthValidFiledComment.push("FK_SUB_COL_ID");
...
AttInventory.prototype.insert = function(){
	var _self = this;
 ...
 * @param 
 */
AttInventory.prototype.nullvalid = function(data,item,nullfiled,notnullFiledComment){
	var msg = "";
 ...
 * @param 
 */
AttInventory.prototype.lengthvalid = function(data,item,lengthValidFiled,lengthValidFiledComment,lengthValidFiledSize){
	var msg = "";
	$.each(data,function(i,dataitem){
 ...
 * 长度和非空校验
 */
 AttInventory.prototype.valid=function(){
	    var _self = this;
	    $(_self._datagridId).jqGrid('endEditCell');
  ...
  * @param pid
  */
 AttInventory.prototype.save = function(pid){
 	var _self = this;
 	_self.pid = pid;
 	$(_self._datagridId).jqGrid('endEditCell');
 	var data = $(_self._datagridId).jqGrid('getRowData');	
  ...
  * 删除
  */
AttInventory.prototype.del = function(){
 	var _self = this;
 	//删除之前结束单元格
 	$(_self._datagridId).jqGrid('endEditCell');
 ...
 * 重载数据
 */
AttInventory.prototype.reLoad=function(pid){
	if(pid != undefined){
		this.pid = pid;
	}
	pid = this.pid;
 ...
 * 关闭对话框
 */
AttInventory.prototype.closeDialog=function(id){
	if(id == "insert"){
 ...
 * 打开高级查询框
 */
AttInventory.prototype.openSearchForm = function(searchDiv,par){
	var _self = this;
	par = null;
	//if(!par) par = $(window);
 ...
 * 高级查询
 */
AttInventory.prototype.searchData =function(){
 ...
 * 关键字段查询
 */
AttInventory.prototype.searchByKeyWord =function(){
 ...
 * 隐藏查询框
 */
AttInventory.prototype.hideSearchForm =function(){
	layer.close(searchDialogindex);
};
/**
 * 清空查询条件
 */
AttInventory.prototype.clearData =function(){
