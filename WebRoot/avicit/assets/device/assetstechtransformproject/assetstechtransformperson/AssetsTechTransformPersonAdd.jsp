...
<html>
<head>
    <!-- ControllerPath = "assets/device/assetstechtransformperson/assetsTechTransformPersonController/operation/Add/null" -->
    <title>添加</title>
    ...
    <form id='form'>
        ...
        <table class="form_commonTable">
            <tr class="commonTableTr">
				...
				<td width="15%">
					<div class="input-group  input-group-sm">
						...
						<input class="form-control" placeholder="请选择用户" type="text" id="userName" name="userName">
                ...
                <td width="15%">
                    <pt6:h5select css_class="form-control input-sm" name="projectRole" id="projectRole" title="" isNull="true" lookupCode="PROJECT_ROLE"/>
                </td>
            ...
            <tr class="commonTableTr">
                ...
                <td width="15%">
                    <pt6:h5select css_class="form-control input-sm" name="userTitle" id="userTitle" title="" isNull="true" lookupCode="PLATFORM_USER_TITLE"/>
                </td>

                <th width="10%">
                    <label for="mobileNumber">手机:</label></th>
                <td width="15%">
                    <input class="form-control input-sm" type="text" name="mobileNumber" id="mobileNumber" readonly/>
                </td>

				<th width="10%">
					<label for="officePhone">办公电话:</label></th>
				<td width="15%">
					<input class="form-control input-sm" type="text" name="officePhone" id="officePhone" readonly/>
				</td>
...
<script type="text/javascript">
    function closeForm() {
        parent.assetsTechTransformPerson.closeDialog("insert");
    }
    ...
    function saveForm() {
        ...
        parent.assetsTechTransformPerson.save($('#form'), "insert");
    }
