...
AssetsTechTransformProject.prototype.init = function () {
    ...
    $(_self._datagridId).jqGrid({
        ...
        loadComplete:function(){
            initContextMenu(_self._datagridId,assetsTechTransformProject);
        },
 ...
 * 添加页面
 */
AssetsTechTransformProject.prototype.insert = function () {
 ...
 * 编辑技改项目页面
 */
AssetsTechTransformProject.prototype.modify = function(){
 ...
 * 保存技改项目方法
 */
AssetsTechTransformProject.prototype.save=function(form,id){
	var _self = this;
	avicAjax.ajax({
 ...
 * 删除技改项目方法
 */
AssetsTechTransformProject.prototype.del = function(){
	var _self = this;
 ...
 * 关闭对话框
 */
AssetsTechTransformProject.prototype.closeDialog = function (windowName) {
	if(windowName == "insert"){
