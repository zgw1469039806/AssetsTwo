 ...
 */
function DynAssetsReconst(datagrid, url, searchForm, dataGridColModel,searchDialog, clickRowLoad, searchMainNames,demoMainDept_KeyWord) {
 ...
 * 初始化操作
 */
DynAssetsReconst.prototype.init=function(){
	var _self = this;
	//初始化流程帮助类
	flowListEditor = new FlowListEditor(this._formCode);
	var issubinit = false;
	$(_self._datagridId).jqGrid({
				url : _self.getUrl() + 'getDynAssetsReconstsByPage.json',
				mtype : 'POST',
				multiselect : true,
				datatype : "json",
				toolbar : [ true, 'top' ],
 ...
 * 添加页面
 */
DynAssetsReconst.prototype.insert = function() {
	//添加流程
 ...
 * 编辑页面
 */
DynAssetsReconst.prototype.modify=function(){
 ...
 * 详情页面
 */
DynAssetsReconst.prototype.detail = function(id, value) {
	flowUtils.detail(id);
};
/**
 * 控件校验   规则：表单字段name与rules对象保持一致
 */
DynAssetsReconst.prototype.formValidate=function(form){
	form.validate({
		rules: {
						  		     			 		  				  		     			    				   					author:{
						maxlength: -1
 ...
 * 保存方法
 */
DynAssetsReconst.prototype.save=function(form,windowName,dataSub){
	var _self = this;
 ...
 * 删除方法
 */
DynAssetsReconst.prototype.del=function(){
    var _self = this;
 ...
 * 重载数据
 */
DynAssetsReconst.prototype.reLoad=function(){
    var searchdata = {
		keyWord : null,
 ...
 * 关闭对话框
 */
DynAssetsReconst.prototype.closeDialog=function(windowName){
	layer.close(layer.getFrameIndex(windowName));
};
/**
 * 打开高级查询框
 */
DynAssetsReconst.prototype.openSearchForm = function(searchDiv,par){
	var _self = this;
	par = null;
	//if(!par) par = $(window);
 ...
 * 高级查询	
 */
DynAssetsReconst.prototype.searchData =function(){
 ...
 * 关键字段查询
 */
DynAssetsReconst.prototype.searchByKeyWord =function(){
 ...
 * 隐藏查询框
 */
DynAssetsReconst.prototype.hideSearchForm =function(){
	layer.close(searchDialogindex);
};
/**
 * 根据流程状态查询
 */
DynAssetsReconst.prototype.initWorkFlow = function(status) {
	$('#bpmState').val(status);
	if(status == "start"){
		$("#dynAssetsReconst_modify").show();
		$("#dynAssetsReconst_del").show();
	}else{
		$("#dynAssetsReconst_modify").hide();
		$("#dynAssetsReconst_del").hide();
	}
	this.searchData();
};
/**
 * 清空查询条件
 */
DynAssetsReconst.prototype.clearData =function(){
