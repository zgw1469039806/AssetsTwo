...
<html>
<head>
    <!-- ControllerPath = "assets/device/assetsdevicereuse/assetsDeviceReuseController/operation/toDetailJsp" -->
...
<div id="formTab" style="display: none">
    <p style="text-align: center;">
        <span style="font-size: 32px; text-align: center;">设备再用申请单</span>
    </p>
    <!-- 业务表单 Start -->
    <form id='form'>
        ...
        <table class="form_commonTable">
            <tr>
                <th width="10%">
                    <label for="procId">再用单号:</label></th>
                <td width="15%">
            ...
            <tr>
                ...
                <td width="15%" colspan="7">
                                        <textarea class="form-control input-sm" rows="5" name="reuseReason"
            ...
            <tr>
                ...
                <td width="90%" colspan="7">
                                        <textarea class="form-control input-sm" rows="5" name="productRiskAnalyse"
            ...
            <tr>
                ...
                <td width="15%">
                    <div class="input-group input-group-sm spinner" data-trigger="spinner">
                        <input class="form-control" type="text" name="totalReuseMoney"
                               id="totalReuseMoney" data-min="-<%=Math.pow(10,12)-Math.pow(10,-3)%>"
                    ...
                    <div id="toolbar_AssetsDeviceReusesub" class="toolbar">
                        <div class="toolbar-left">
                            ...
                            <a class="btn btn-default form-tool-btn btn-sm bpm_self_class"
                               ...
                               name="assetsDeviceReusesub_editable"
                               id="assetsDeviceReusesub_editable">是否可编辑</a>
                        </div>
                    </div>
                    <table id="assetsDeviceReusesub" name="ASSETS_DEVICE_REUSESUB"
                           class="customform_subtable_bpm_auth"></table>
                    <pt6:h5resource label="统一编号" name="unifiedId"
                                    ref_table="ASSETS_DEVICE_REUSESUB"></pt6:h5resource>
...
<!-- 业务的js -->
<script type="text/javascript" src="avicit/assets/device/assetsdevicereuse/js/AssetsDeviceReuseDetail.js"></script>
<script type="text/javascript" src="avicit/assets/device/assetsdevicereuse/js/AssetsDeviceReusesub.js"></script>
<script type="text/javascript" src="avicit/assets/device/assetsdevicereuse/js/SelfStyleLayout.js"></script>
<!-- 自动编码的js -->
...
<script type="text/javascript">
    ...
    function initOnceInAdd() {
        avicAjax.ajax({
            url: "platform/assets/device/assetsdevicereuse/assetsDeviceReuseController/getLookUpCode",
            type: 'post',
            dataType: 'json',
            async: false,
            success: function (r) {
    ...
    var assetsDeviceReusesubGridColModel = null;
    $(document).ready(function () {
        ...
        //自动生成设备移交编号
        var autoCode = new AutoCode("DEVICE_REUSED_PROC", "procId", false, "autoCodeValue", "123");
        ...
        var assetsDeviceReusesub = new AssetsDeviceReusesub('assetsDeviceReusesub', surl,
            "formSub",
            assetsDeviceReusesubGridColModel,
            'searchDialogSub', pid, searchSubNames, 'assetsDeviceReusesub_keyWord', isReload);
        //创建业务操作JS
        var assetsDeviceReuseDetail = new AssetsDeviceReuseDetail('form', assetsDeviceReusesub);
        //创建流程操作JS
        new FlowEditor(assetsDeviceReuseDetail);
        ...
        //绑定表单验证规则
        assetsDeviceReuseDetail.formValidate($('#form'));
        //初始化附件上传组件
        ...
        $('#assetsDeviceReusesub_insert').bind('click', function () {
            ...
            var param =  JSON.stringify({DEVICE_STATE:"2"}); /* 筛选闲置状态的设备 */
    ...
    window.onload = function () {
        $('#cb_assetsDeviceReusesub').attr("disabled", false);
    }
</script>
</body>
</html>