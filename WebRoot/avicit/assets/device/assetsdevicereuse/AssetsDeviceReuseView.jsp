    ...
    <form id='form'>
        ...
        <table class="form_commonTable">
            <tr>
                ...
                <td width="15%">
                    <input class="form-control input-sm" type="text" name="createdByTel" id="createdByTel"
                           readonly="readonly" value="<c:out  value='${assetsDeviceReuseDTO.createdByTel}'/>"/>
                </td>
                <th width="10%" style="word-break:break-all;word-warp:break-word;">
            ...
            <tr>
                ...
                <td width="15%">
                    <textarea class="form-control input-sm" rows="3" readonly="readonly" name="reuseReason"
                              id="reuseReason"><c:out value='${assetsDeviceReuseDTO.reuseReason}'/></textarea>
                </td>
                <th width="10%" style="word-break:break-all;word-warp:break-word;">
                ...
                <td width="15%">
                    <div class="input-group input-group-sm spinner" data-trigger="spinner">
                        <input class="form-control" type="text" name="totalReuseMoney" id="totalReuseMoney"
                               readonly="readonly" value="<c:out  value='${assetsDeviceReuseDTO.totalReuseMoney}'/>"
