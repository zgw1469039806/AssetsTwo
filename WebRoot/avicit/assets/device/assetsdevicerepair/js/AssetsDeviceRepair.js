 ...
 */
function AssetsDeviceRepair(datagrid, url, searchD, form, keyWordId, searchNames, dataGridColModel) {
    ...
    this._formCode = "deviceRepair1"; //表单的code，启动流程时需要
 ...
 * 初始化操作
 */
AssetsDeviceRepair.prototype.init = function () {
    var _self = this;
    //初始化流程帮助类
    flowListEditor = new FlowListEditor(this._formCode);
    $(_self._datagridId).jqGrid({
        url: _self.getUrl() + 'getAssetsDeviceRepairsByPage.json',
        mtype: 'POST',
        datatype: "json",
 ...
 * 添加页面
 */
AssetsDeviceRepair.prototype.insert = function () {
    //添加流程
    // flowListEditor.addFlow();
    _bpm_listeditor_start("402880e67347278f017347330ea20157-2", "设备维修")
};
AssetsDeviceRepair.prototype.insert1 = function () {
    //添加流程
    // flowListEditor.addFlow();
    _bpm_listeditor_start("402880e6736ee40801736ee61a3b02b7-1", "设备工单")
};
/**
 * 编辑页面
 */
AssetsDeviceRepair.prototype.modify = function () {
 ...
 * 详情页面
 */
AssetsDeviceRepair.prototype.detail = function (id, value) {
    flowUtils.detail(id);
};
/**
 * 打开高级查询框
 */
AssetsDeviceRepair.prototype.openSearchForm = function (searchBtn, contentWidth, contentHeight) {
    var _self = this;
    var _resizeFunc;
 ...
 */
AssetsDeviceRepair.prototype.formValidate = function (form) {
    form.validate({
        rules: {
            applicantIdAlias: {
                required: true,
 ...
 * 保存方法
 */
AssetsDeviceRepair.prototype.save = function (form, windowName, callback) {
    var _self = this;
    avicAjax.ajax({
 ...
 * 删除方法
 */
AssetsDeviceRepair.prototype.del = function () {
    var _self = this;
 ...
 * 重载数据
 */
AssetsDeviceRepair.prototype.reLoad = function () {
    var searchdata = {
        keyWord: null,
 ...
 * 关闭对话框
 */
AssetsDeviceRepair.prototype.closeDialog = function (windowName, msg) {
    layer.close(layer.getFrameIndex(windowName));
    if (msg && msg !== '') {
        layer.msg(msg);
    }
 ...
 * 后台查询
 */
AssetsDeviceRepair.prototype.searchData = function () {
 ...
 * 关键字段查询
 */
AssetsDeviceRepair.prototype.searchByKeyWord = function () {
 ...
 * 根据流程状态查询
 */
AssetsDeviceRepair.prototype.initWorkFlow = function (status) {
    $('#bpmState').val(status);
    if (status == "start") {
        $("#assetsDeviceRepair_modify").show();
        $("#assetsDeviceRepair_del").show();
    } else {
        $("#assetsDeviceRepair_modify").hide();
        $("#assetsDeviceRepair_del").hide();
    }
    this.searchData();
};
/**
 * 清空查询条件
 */
AssetsDeviceRepair.prototype.clearData = function () {
