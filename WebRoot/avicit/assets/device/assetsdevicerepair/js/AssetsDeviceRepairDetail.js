 ...
 */
function AssetsDeviceRepairDetail(form) {
    this._formId = "#" + form;
    DefaultForm.call(this);
};
AssetsDeviceRepairDetail.prototype = new DefaultForm();
//formcode
AssetsDeviceRepairDetail.prototype.formcode = "deviceRepair";
//初始化操作
AssetsDeviceRepairDetail.prototype.initFormData = function () {
    var _self = this;
    avicAjax.ajax({
        url: 'platform/assets/device/assetsdevicerepair/assetsDeviceRepairController/toDetailJsp.json',
        data: {
            id: _self.id
        },
        type: 'POST',
        ...
        success: function (result) {
            if (result.flag == "success") {
                _self.setForm($(_self._formId), result.assetsDeviceRepairDTO);
            } else {
                layer.msg('数据加载失败！');
            }
        }
...
//启动流程
AssetsDeviceRepairDetail.prototype.start = function (defineId, callback) {
    var _self = this;
    //表单校验
    ...
    avicAjax.ajax({
        url: 'platform/assets/device/assetsdevicerepair/assetsDeviceRepairController/operation/saveAndStartProcess',
        data: {
...
//更新数据
AssetsDeviceRepairDetail.prototype.save = function (callback) {
    var _self = this;
    //表单校验
    var isValidate = $("#form").validate();
    if (!isValidate.checkForm()) {
    ...
    var dataVo = JSON.stringify(serializeObject($(_self._formId)));
    avicAjax.ajax({
        url: 'platform/assets/device/assetsdevicerepair/assetsDeviceRepairController/operation/save',
        data: {
            data: dataVo
        },
        type: 'POST',
...
//表单重载json对象数据
AssetsDeviceRepairDetail.prototype.setForm = function (formObj, jsonValue) {
    var obj = formObj;
...
//控制附件
AssetsDeviceRepairDetail.prototype.setAttachMagic = function (attachMagic) {
...
//流程控制-多附件必填
AssetsDeviceRepairDetail.prototype.setAttachRequired = function (tagId, required, obj) {
    eval("this.attachRequiredMap." + tagId + " = " + required);
};

AssetsDeviceRepairDetail.prototype.attachRequiredMap = {};
AssetsDeviceRepairDetail.prototype.validAttachRequired = function () {
...
//多附件增删控制
AssetsDeviceRepairDetail.prototype.setAttachCanAddOrDel = function (tagId, operability, obj) {
    if (operability) {
...
AssetsDeviceRepairDetail.prototype.formValidate = function (form) {
    form.validate({
        rules: {
            applicantIdAlias: {
                required: true,
