...
<div data-options="region:'center',split:true,border:false">
    <form id='form'>
        ...
        <table class="form_commonTable">
            <tr>
				<th width="10%">
					<label for="belongTable">所属表:</label></th>
				<td width="39%">
					<input class="form-control input-sm" type="text" name="belongTable" id="belongTable"/>
				</td>

				<th width="10%"></th><td width="39%"></td>
            </tr>
            <tr>
                <th width="10%">
                    <label for="fieldModel">字段描述:</label></th>
                <td width="88%" colspan="3">
                    <textarea class="form-control input-sm" rows="3" name="fieldModel" id="fieldModel"></textarea>
                </td>
            </tr>
            <tr>
...
<script type="text/javascript">
    ...
    function saveForm() {
        ...
        parent.userTableModel.batchSave($('#form'), "insert");
    }
