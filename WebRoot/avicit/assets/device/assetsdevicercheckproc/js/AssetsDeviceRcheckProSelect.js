 ...
 */
function AssetsDeviceRcheckProSelect(datagrid, url, searchDialogId, form, keyWordId, searchNames, dataGridColModel) {
    if (!datagrid || typeof(datagrid) !== 'string' && datagrid.trim() !== '') {
        throw new Error("datagrid不能为空！");
    }
    var _url = "platform/assets/device/assetsdeviceregularcheck/assetsDeviceRegularCheckController/operation/";
 ...
 * 初始化操作
 */
AssetsDeviceRcheckProSelect.prototype.init = function () {
    var _self = this;
    ...
    $(_self._datagridId).jqGrid({
        ...
        height: $("#regularCheckIframe").height(),//初始化表格高度
...
AssetsDeviceRcheckProSelect.prototype.insert = function () {
    var _self = this;
 ...
 * @param
 */
AssetsDeviceRcheckProSelect.prototype.nullvalid = function (data, item, nullfiled, notnullFiledComment) {
    var msg = "";
 ...
 * @param
 */
AssetsDeviceRcheckProSelect.prototype.lengthvalid = function (data, item, lengthValidFiled, lengthValidFiledComment, lengthValidFiledSize) {
    var msg = "";
    $.each(data, function (i, dataitem) {
 ...
 * @param callback
 */
AssetsDeviceRcheckProSelect.prototype.save = function () {
    var _self = this;
    var $info = $(_self._datagridId).jqGrid('endEditCell');
    if ($info[0].flag) {
        layer.alert("非法含有JS脚本完整标签");
 ...
 * @param id
 */
AssetsDeviceRcheckProSelect.prototype.detail = function (id) {
 ...
 * 删除
 */
AssetsDeviceRcheckProSelect.prototype.del = function () {
    var _self = this;
 ...
 * 重载数据
 */
AssetsDeviceRcheckProSelect.prototype.reLoad = function () {
    var searchdata = {
        keyWord: null,
 ...
 */
AssetsDeviceRcheckProSelect.prototype.openSearchForm = function (searchDiv) {
    var _self = this;
 ...
 * 高级查询
 */
AssetsDeviceRcheckProSelect.prototype.searchData = function () {
 ...
 * 关键字查询
 */
AssetsDeviceRcheckProSelect.prototype.searchByKeyWord = function () {
...
AssetsDeviceRcheckProSelect.prototype.submit = function(){
    var item = sessionStorage.getItem("param");
    var obj= JSON.parse(item);
    var _self = this;
    if(!callBackFn){
    ...
    parent[callBackFn](selectIds.join(','), obj.nextRegularCheckDateEnd,requestType);
}
