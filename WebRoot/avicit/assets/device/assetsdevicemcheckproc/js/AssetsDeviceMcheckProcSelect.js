 ...
 */
function AssetsDeviceMcheckProcSelect(datagrid, url, searchDialogId, form, keyWordId, searchNames, dataGridColModel) {
    if (!datagrid || typeof(datagrid) !== 'string' && datagrid.trim() !== '') {
        throw new Error("datagrid不能为空！");
    }
    var _url = "platform/assets/device/assetsdevicemaintain/assetsDeviceMaintainController/operation/";
 ...
 * 初始化操作
 */
AssetsDeviceMcheckProcSelect.prototype.init = function () {
    var _self = this;
    ...
    $(_self._datagridId).jqGrid({
        ...
        height: $("#maintainIframe").height(),//初始化表格高度
...
AssetsDeviceMcheckProcSelect.prototype.insert = function () {
    var _self = this;
 ...
 * @param
 */
AssetsDeviceMcheckProcSelect.prototype.nullvalid = function (data, item, nullfiled, notnullFiledComment) {
    var msg = "";
 ...
 * @param
 */
AssetsDeviceMcheckProcSelect.prototype.lengthvalid = function (data, item, lengthValidFiled, lengthValidFiledComment, lengthValidFiledSize) {
    var msg = "";
    $.each(data, function (i, dataitem) {
 ...
 * @param callback
 */
AssetsDeviceMcheckProcSelect.prototype.save = function () {
    var _self = this;
    var $info = $(_self._datagridId).jqGrid('endEditCell');
    if ($info[0].flag) {
        layer.alert("非法含有JS脚本完整标签");
 ...
 * @param id
 */
AssetsDeviceMcheckProcSelect.prototype.detail = function (id) {
 ...
 * 删除
 */
AssetsDeviceMcheckProcSelect.prototype.del = function () {
    var _self = this;
 ...
 * 重载数据
 */
AssetsDeviceMcheckProcSelect.prototype.reLoad = function () {
    var searchdata = {
        keyWord: null,
 ...
 */
AssetsDeviceMcheckProcSelect.prototype.openSearchForm = function (searchDiv) {
    var _self = this;
 ...
 * 高级查询
 */
AssetsDeviceMcheckProcSelect.prototype.searchData = function () {
 ...
 * 关键字查询
 */
AssetsDeviceMcheckProcSelect.prototype.searchByKeyWord = function () {
 ...
 * 关键字查询-外部传参调用
 */
AssetsDeviceMcheckProcSelect.prototype.searchByTransKeyWord = function () {
    var keyWord = $(this._keyWordId).val() == $(this._keyWordId).attr("placeholder") ? "" : $(this._keyWordId).val();
    var names = this._searchNames;
...
AssetsDeviceMcheckProcSelect.prototype.submit = function(){
    var item = sessionStorage.getItem("param");
    var obj= JSON.parse(item);
    var _self = this;
    if(!callBackFn){
    ...
    parent[callBackFn](selectIds.join(','), obj.nextMaintainDateEnd,requestType);
}
