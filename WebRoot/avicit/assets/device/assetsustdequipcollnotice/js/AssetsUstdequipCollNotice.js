 ...
 * 
 */
function AssetsUstdequipCollNotice(datagrid, url, searchForm, dataGridColModel, searchDialog, afterInit, clickRowLoad,searchMainNames,demoMainDept_KeyWord){
...
//初始化操作
AssetsUstdequipCollNotice.prototype.init=function(){
	var _self = this;
	var issubinit = false;
	$(_self._datagridId).jqGrid({
    	url: this.getUrl()+'getAssetsUstdequipCollNoticesByPage.json',
        mtype: 'POST',
        multiselect:true, 
        datatype: "json",
        toolbar: [true,'top'],
...
//添加页面
AssetsUstdequipCollNotice.prototype.insert=function(){
...
//编辑页面
AssetsUstdequipCollNotice.prototype.modify=function(){
...
//详细页
AssetsUstdequipCollNotice.prototype.detail=function(id){
...
AssetsUstdequipCollNotice.prototype.formValidate=function(form){
	form.validate({
		rules: {
						  		     			 		  				  		     			    				   					noticeNo:{
						maxlength: 50
...
//保存功能
AssetsUstdequipCollNotice.prototype.save=function(form,id){
	var _self = this;
	avicAjax.ajax({
...
//删除
AssetsUstdequipCollNotice.prototype.del=function(){
...
//重载数据
AssetsUstdequipCollNotice.prototype.reLoad=function(){
...
//关闭对话框
AssetsUstdequipCollNotice.prototype.closeDialog=function(id){
	if(id == "insert"){
...
//打开高级查询框
AssetsUstdequipCollNotice.prototype.openSearchForm = function(searchDiv,par){
	var _self = this;
	par = null;
	//if(!par) par = $(window);
...
//高级查询
AssetsUstdequipCollNotice.prototype.searchData =function(){
	var searchdata = {
			keyWord: null,
...
//关键字段查询
AssetsUstdequipCollNotice.prototype.searchByKeyWord =function(){
...
//隐藏查询框
AssetsUstdequipCollNotice.prototype.hideSearchForm =function(){
	layer.close(searchDialogindex);
};
/*清空查询条件*/
AssetsUstdequipCollNotice.prototype.clearData =function(){
