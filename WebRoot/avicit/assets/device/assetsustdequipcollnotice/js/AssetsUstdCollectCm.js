function AssetsUstdCollectCm(datagrid, url, formSub, dataGridColModel,searchDialogSub, pid, searchSubNames, demoSubUser_KeyWord){
...
AssetsUstdCollectCm.prototype.init=function(pid){
	...
	$(_self._datagridId).jqGrid({
    	url: this.getUrl()+'getAssetsUstdCollectCm',
...
//添加页面
AssetsUstdCollectCm.prototype.insert=function(pid){
...
//修改页面
AssetsUstdCollectCm.prototype.modify=function(){
	if(this.pid == null || this.pid == ""){
		 layer.alert('请选择一条要编辑的主表数据！', {
				  icon: 7,
				  area: ['400px', ''], //宽高
...
//详细页
AssetsUstdCollectCm.prototype.detail=function(id){
...
AssetsUstdCollectCm.prototype.formValidate=function(form){
	form.validate({
		rules: {
						  		     			 		  				  		     			    				   					stdId:{
						maxlength: 50
...
//保存功能
AssetsUstdCollectCm.prototype.save=function(form,id){
	var _self = this;
	avicAjax.ajax({
