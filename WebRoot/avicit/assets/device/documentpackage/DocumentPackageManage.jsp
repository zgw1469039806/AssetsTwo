		...
		<div id="panelnorth"
			...
			<div id="toolbar_documentPackage" class="toolbar">
				<div class="toolbar-left">
					...
					<sec:accesscontrollist hasPermission="3" domainObject="formdialog_documentPackage_button_edit" permissionDes="主表编辑">
						<a id="documentPackage_modify" href="javascript:void(0)" class="btn btn-default form-tool-btn btn-sm" role="button" title="编辑">
							<i class="fa fa-file-text-o"></i> 编辑
						</a>
					</sec:accesscontrollist>
					<sec:accesscontrollist hasPermission="3" domainObject="formdialog_documentPackage_button_delete" permissionDes="主表删除">
						<a id="documentPackage_del" href="javascript:void(0)" class="btn btn-default form-tool-btn btn-sm" role="button" title="删除">
		...
		<div id="centerpanel"
			...
			<div id="toolbar_documentItem" class="toolbar">
				<div class="toolbar-left">
					...
					<sec:accesscontrollist hasPermission="3" domainObject="formdialog_documentItem_button_edit" permissionDes="子表编辑">
						<a id="documentItem_modify" href="javascript:void(0)" class="btn btn-default form-tool-btn btn-sm" role="button" title="编辑">
							<i class="fa fa-file-text-o"></i> 编辑
						</a>
					</sec:accesscontrollist>
					<sec:accesscontrollist hasPermission="3" domainObject="formdialog_documentItem_button_delete" permissionDes="子表删除">
						<a id="documentItem_del" href="javascript:void(0)" class="btn btn-default form-tool-btn btn-sm" role="button" title="删除">
							<i class="fa fa-trash-o"></i> 删除
						</a>
					</sec:accesscontrollist>
				</div>
