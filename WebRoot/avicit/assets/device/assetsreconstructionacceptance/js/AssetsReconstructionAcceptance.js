 ...
 */
function AssetsUstdtempAcceptance(datagrid,url,searchD,form,keyWordId,searchNames,dataGridColModel){
    ...
    this._formCode = "assetsReconstructionAcceptance"; //表单的code，启动流程时需要
 ...
 * 打开高级查询框
 */
AssetsUstdtempAcceptance.prototype.openSearchForm = function(searchBtn, contentWidth, contentHeight){
	var _self = this;
	var _resizeFunc;
 ...
 * 保存方法
 */
AssetsUstdtempAcceptance.prototype.save=function(form,windowName,callback){
	var _self = this;
	avicAjax.ajax({
 ...
 * 关闭对话框
 */
AssetsUstdtempAcceptance.prototype.closeDialog=function(windowName, msg){
	layer.close(layer.getFrameIndex(windowName));
	if(msg && msg !== ''){
		layer.msg(msg);
	}
 ...
 * 后台查询	
 */
AssetsUstdtempAcceptance.prototype.searchData =function(){
