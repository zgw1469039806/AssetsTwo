 ...
 */
function AssetsDeviceRegularCheck(datagrid, url, searchDialogId, form, keyWordId, searchNames, dataGridColModel) {
 ...
 * 初始化操作
 */
AssetsDeviceRegularCheck.prototype.init = function () {
    var _self = this;
    ...
    /*初始化即按统一编号查询-end*/
    var heighit = $("#regularCheckIframe", window.parent.document).height();
    $(_self._datagridId).jqGrid({
        url: _self.getUrl() + 'getAssetsDeviceRegularChecksByPage.json',
        mtype: 'POST',
    ...
    $(_self._datagridId).setColProp("deviceModel",{editable:false});
    $(_self._datagridId).setColProp("manufacturerId",{editable:false});
    ...
    $(_self._datagridId).setColProp("regularCheckCycle",{editable:false});
    $(_self._datagridId).setColProp("regularCheckModeName",{editable:false});
    $(_self._datagridId).setColProp("lastRegularCheckDate",{editable:false});
    $(_self._datagridId).setColProp("nextRegularCheckDate",{editable:false});
    $(_self._datagridId).setColProp("regularCheckConclutionName",{editable:false});
    $(_self._datagridId).setColProp("registerId",{editable:false});
    $(_self._datagridId).setColProp("attachment",{editable:false});
    //设置单元格不可编辑-end
...
AssetsDeviceRegularCheck.prototype.insert = function () {
    var _self = this;
    ...
    var newRowDeviceData = {
        ...
        "deviceModel":deviceAccountDataObj.deviceModel,
        "manufacturerId":deviceAccountDataObj.manufacturerId,
 ...
 * @param
 */
AssetsDeviceRegularCheck.prototype.nullvalid = function (data, item, nullfiled, notnullFiledComment) {
    var msg = "";
 ...
 * @param
 */
AssetsDeviceRegularCheck.prototype.lengthvalid = function (data, item, lengthValidFiled, lengthValidFiledComment, lengthValidFiledSize) {
    var msg = "";
    $.each(data, function (i, dataitem) {
 ...
 * @param callback
 */
AssetsDeviceRegularCheck.prototype.save = function () {
    var _self = this;
    var $info = $(_self._datagridId).jqGrid('endEditCell');
    if ($info[0].flag) {
        layer.alert("非法含有JS脚本完整标签");
 ...
 * 编辑
 */
AssetsDeviceRegularCheck.prototype.edit = function () {
    var _self = this;
 ...
 * @param id
 */
AssetsDeviceRegularCheck.prototype.detail = function (id) {
 ...
 * 删除
 */
AssetsDeviceRegularCheck.prototype.del = function () {
    var _self = this;
    var rows = $(_self._datagridId).jqGrid('getGridParam', 'selarrrow');
    var ids = [];
    var l = rows.length;
 ...
 * 重载数据
 */
AssetsDeviceRegularCheck.prototype.reLoad = function () {
    /*获取session的筛选数据-begin*/
    var deviceAccountData = sessionStorage.getItem("deviceAccountData");
    var deviceAccountDataObj = JSON.parse(deviceAccountData);
    if(sessionStorage.getItem("deviceAccountData")!=""){
 ...
 */
AssetsDeviceRegularCheck.prototype.openSearchForm = function (searchDiv) {
    var _self = this;
 ...
 * 高级查询
 */
AssetsDeviceRegularCheck.prototype.searchData = function () {
 ...
 * 关键字查询
 */
AssetsDeviceRegularCheck.prototype.searchByKeyWord = function () {
 ...
 * 设置单元格可编辑
 */
AssetsDeviceRegularCheck.prototype.setColEditable = function (rowid) {
    if(rowid != "" && rowid != undefined && rowid != null )
    {
        //设置单元格背景颜色-begin
        $(this._datagridId).jqGrid('setCell', rowid, 'regularCheckCycle', '', {'background-color': '#ffffff'});
        $(this._datagridId).jqGrid('setCell', rowid, 'regularCheckModeName', '', {'background-color': '#ffffff'});
        $(this._datagridId).jqGrid('setCell', rowid, 'lastRegularCheckDate', '', {'background-color': '#ffffff'});
        $(this._datagridId).jqGrid('setCell', rowid, 'nextRegularCheckDate', '', {'background-color': '#ffffff'});
        $(this._datagridId).jqGrid('setCell', rowid, 'regularCheckConclutionName', '', {'background-color': '#ffffff'});
        $(this._datagridId).jqGrid('setCell', rowid, 'registerId', '', {'background-color': '#ffffff'});
        $(this._datagridId).jqGrid('setCell', rowid, 'attachment', '', {'background-color': '#ffffff'});
        //设置单元格背景颜色-end
    }
    //设置单元格可编辑-begin
    $(this._datagridId).setColProp("regularCheckCycle",{editable:true});
    $(this._datagridId).setColProp("regularCheckModeName",{editable:true});
    $(this._datagridId).setColProp("lastRegularCheckDate",{editable:true});
    $(this._datagridId).setColProp("nextRegularCheckDate",{editable:true});
    $(this._datagridId).setColProp("regularCheckConclutionName",{editable:true});
    $(this._datagridId).setColProp("registerId",{editable:true});
    $(this._datagridId).setColProp("attachment",{editable:true});
    //设置单元格可编辑-end
}
 ...
 * 设置单元格不可编辑
 */
AssetsDeviceRegularCheck.prototype.setColUnEditable = function () {
    //设置单元格不可编辑-begin
    $(this._datagridId).setColProp("regularCheckCycle",{editable:false});
    $(this._datagridId).setColProp("regularCheckModeName",{editable:false});
    $(this._datagridId).setColProp("lastRegularCheckDate",{editable:false});
    $(this._datagridId).setColProp("nextRegularCheckDate",{editable:false});
    $(this._datagridId).setColProp("regularCheckConclutionName",{editable:false});
    $(this._datagridId).setColProp("registerId",{editable:false});
    $(this._datagridId).setColProp("attachment",{editable:false});
    //设置单元格不可编辑-end
}