 ...
 */
function AssetsDeviceComponent(datagrid, url, searchDialogId, form, keyWordId, searchNames, dataGridColModel) {
 ...
 * 初始化操作
 */
AssetsDeviceComponent.prototype.init = function () {
    var _self = this;
    ...
    $(_self._datagridId).jqGrid({
        url: _self.getUrl() + 'getAssetsDeviceComponentsByPage.json',
        mtype: 'POST',
        ...
        height: $("#componentIframe").height(),//初始化表格高度
    ...
    //初始化校验字段
    _self.notnullFiled.push("parentUnifiedId");
    _self.notnullFiledComment.push("主设备统一编号");
    ...
    _self.notnullFiledComment.push("随机备件名称");
    _self.lengthValidFiled.push("componentName");
    _self.lengthValidFiledSize.push(50);
    _self.lengthValidFiledComment.push("随机备件名称");
    _self.lengthValidFiled.push("componentCategory");
    _self.lengthValidFiledSize.push(50);
    _self.lengthValidFiledComment.push("随机备件类别");
    _self.lengthValidFiled.push("componentModel");
    _self.lengthValidFiledSize.push(50);
    _self.lengthValidFiledComment.push("随机备件型号");

    //设置单元格不可编辑-begin
    $(this._datagridId).setColProp("parentUnifiedId",{editable:false});
    $(this._datagridId).setColProp("componentName",{editable:false});
    $(this._datagridId).setColProp("componentCategory",{editable:false});
...
AssetsDeviceComponent.prototype.insert = function () {
    var _self = this;
    ...
    var newRowDeviceData = {
        "parentUnifiedId":deviceAccountDataObj.unifiedId,
    };
 ...
 * @param
 */
AssetsDeviceComponent.prototype.nullvalid = function (data, item, nullfiled, notnullFiledComment) {
    var msg = "";
 ...
 * @param
 */
AssetsDeviceComponent.prototype.lengthvalid = function (data, item, lengthValidFiled, lengthValidFiledComment, lengthValidFiledSize) {
    var msg = "";
    $.each(data, function (i, dataitem) {
 ...
 * @param callback
 */
AssetsDeviceComponent.prototype.save = function () {
    var _self = this;
    var $info = $(_self._datagridId).jqGrid('endEditCell');
    if ($info[0].flag) {
        layer.alert("非法含有JS脚本完整标签");
 ...
 * 编辑
 */
AssetsDeviceComponent.prototype.edit = function () {
    var _self = this;
 ...
 * @param id
 */
AssetsDeviceComponent.prototype.detail = function (id) {
 ...
 * 删除
 */
AssetsDeviceComponent.prototype.del = function () {
    var _self = this;
    var rows = $(_self._datagridId).jqGrid('getGridParam', 'selarrrow');
    var ids = [];
    var l = rows.length;
 ...
 * 重载数据
 */
AssetsDeviceComponent.prototype.reLoad = function () {
    /*获取session的筛选数据-begin*/
    var deviceAccountData = sessionStorage.getItem("deviceAccountData");
    var deviceAccountDataObj = JSON.parse(deviceAccountData);
    if(sessionStorage.getItem("deviceAccountData")!=""){
    ...
    paramObj.parentUnifiedId = deviceAccountDataObj.unifiedId;
 ...
 */
AssetsDeviceComponent.prototype.openSearchForm = function (searchDiv) {
    var _self = this;
 ...
 * 高级查询
 */
AssetsDeviceComponent.prototype.searchData = function () {
 ...
 * 关键字查询
 */
AssetsDeviceComponent.prototype.searchByKeyWord = function () {
 ...
 * 设置单元格可编辑
 */
AssetsDeviceComponent.prototype.setColEditable = function (rowid) {
    if(rowid != "" && rowid != undefined && rowid != null )
    {
        //设置单元格背景颜色-begin
        $(this._datagridId).jqGrid('setCell', rowid, 'componentName', '', {'background-color': '#ffffff'});
        $(this._datagridId).jqGrid('setCell', rowid, 'componentCategory', '', {'background-color': '#ffffff'});
    ...
    $(this._datagridId).setColProp("componentCategory",{editable:true});
 ...
 * 设置单元格不可编辑
 */
AssetsDeviceComponent.prototype.setColUnEditable = function () {
    //设置单元格不可编辑-begin
    $(this._datagridId).setColProp("componentName",{editable:false});
    $(this._datagridId).setColProp("componentCategory",{editable:false});
    $(this._datagridId).setColProp("componentModel",{editable:false});
