function AssetsSupplier(datagrid, url, formSub, dataGridColModel,searchDialogSub, pid, searchSubNames, demoSubUser_KeyWord, isReload){
 ...
 * 初始化操作
 */
AssetsSupplier.prototype.init=function(pid){
	var _self = this;
	if(_self.isReload == "true"){
			$(_self._datagridId).jqGrid({
			url: _self.getUrl()+'getAssetsSupplier',
	    	postData : {pid : _self.pid},
	        mtype: 'POST',
	        datatype: "json",
	        toolbar: [true,'top'],
	        colModel: assetsSupplierGridColModel, 
...
//禁止时间和日期格式手输
	...
	//初始化校验字段
				      ...
				      _self.lengthValidFiledComment.push("供应商名称");
				     				    															   					     				      _self.lengthValidFiled.push("address");
				      _self.lengthValidFiledSize.push(255);
				      _self.lengthValidFiledComment.push("供应商地址");
				     				    															   					     				      _self.lengthValidFiled.push("contact");
				      _self.lengthValidFiledSize.push(50);
				      _self.lengthValidFiledComment.push("联系人");
				     				    															   					     				      _self.lengthValidFiled.push("contactNumber");
				      _self.lengthValidFiledSize.push(20);
				      _self.lengthValidFiledComment.push("联系电话");
				     				    															   					     				      _self.lengthValidFiled.push("businessScope");
				      _self.lengthValidFiledSize.push(500);
				      _self.lengthValidFiledComment.push("经验范围");
				     				    																											   					     				      _self.lengthValidFiled.push("status");
				      _self.lengthValidFiledSize.push(2);
				      _self.lengthValidFiledComment.push("供应商状态：0:正常状态 2:停用");
				     				    																																																																																	   					     				      _self.lengthValidFiled.push("levelUpId");
				      _self.lengthValidFiledSize.push(50);
				      _self.lengthValidFiledComment.push("父ID");
...
AssetsSupplier.prototype.insert = function(){
	var _self = this;
 ...
 * @param 
 */
AssetsSupplier.prototype.nullvalid = function(data,item,nullfiled,notnullFiledComment){
	var msg = "";
 ...
 * @param 
 */
AssetsSupplier.prototype.lengthvalid = function(data,item,lengthValidFiled,lengthValidFiledComment,lengthValidFiledSize){
	var msg = "";
	$.each(data,function(i,dataitem){
 ...
 * 长度和非空校验
 */
 AssetsSupplier.prototype.valid=function(){
	    var _self = this;
	    $(_self._datagridId).jqGrid('endEditCell');
  ...
  * @param pid
  */
 AssetsSupplier.prototype.save = function(pid){
 	var _self = this;
 	_self.pid = pid;
 	$(_self._datagridId).jqGrid('endEditCell');
 	var data = $(_self._datagridId).jqGrid('getRowData');	
  ...
  * 删除
  */
AssetsSupplier.prototype.del = function(){
 	var _self = this;
 	//删除之前结束单元格
 	$(_self._datagridId).jqGrid('endEditCell');
 ...
 * 重载数据
 */
AssetsSupplier.prototype.reLoad=function(pid){
	if(pid != undefined){
		this.pid = pid;
	}
	pid = this.pid;
 ...
 * 关闭对话框
 */
AssetsSupplier.prototype.closeDialog=function(id){
	if(id == "insert"){
 ...
 * 打开高级查询框
 */
AssetsSupplier.prototype.openSearchForm = function(searchDiv,par){
	var _self = this;
	par = null;
	//if(!par) par = $(window);
 ...
 * 高级查询
 */
AssetsSupplier.prototype.searchData =function(){
 ...
 * 关键字段查询
 */
AssetsSupplier.prototype.searchByKeyWord =function(){
 ...
 * 隐藏查询框
 */
AssetsSupplier.prototype.hideSearchForm =function(){
	layer.close(searchDialogindex);
};
/**
 * 清空查询条件
 */
AssetsSupplier.prototype.clearData =function(){
