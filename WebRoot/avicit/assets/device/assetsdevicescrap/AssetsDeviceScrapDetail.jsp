...
<html>
<head>
    <!-- ControllerPath = "assets/device/assetsdevicescrap/assetsDeviceScrapController/operation/toDetailJsp" -->
                        ...
                        <form id='form'>
                            ...
                            <table class="form_commonTable">
                                ...
                                <tr>
                                    ...
                                    <td width="15%">
                                        <input class="form-control input-sm" type="text" name="assetId" id="assetId" readonly onclick="relateAssets()"/>
                                    </td>
                                    <th width="10%">
                                ...
                                <tr>
                                    ...
                                    <td width="15%">
                                        <div class="input-group input-group-sm">
                                            <input class="form-control date-picker" type="text" name="createdDate"
                                                   id="createdDate"/><span class="input-group-addon"><i
                                    ...
                                    <td width="15%">
                                        <input class="form-control input-sm" type="text" name="positionId"
                                               id="positionId"/>
                                    </td>
                                    <th width="10%">
                                    ...
                                    <td width="15%">
                                        <div class="input-group input-group-sm spinner" data-trigger="spinner">
                                            <input class="form-control" type="text" name="originalValue"
                                                   id="originalValue" data-min="-<%=Math.pow(10,12)-Math.pow(10,-2)%>"
                                ...
                                <tr>
                                    ...
                                    <td width="15%">
                                        <div class="input-group input-group-sm spinner" data-trigger="spinner">
                                            <input class="form-control" type="text" name="totalDepreciation"
                                ...
                                <tr>
                                    ...
                                    <td width="15%">
                                        <textarea class="form-control input-sm" rows="3" name="scrapReason"
...
<!-- 业务的js -->
<script src="avicit/assets/device/assetsdevicescrap/js/AssetsDeviceScrapDetail.js"></script>
<script type="text/javascript">
    ...
    $(document).ready(function () {
        //创建业务操作JS
        var assetsDeviceScrapDetail = new AssetsDeviceScrapDetail('form');
        //创建流程操作JS
        new FlowEditor(assetsDeviceScrapDetail);
        ...
        //绑定表单验证规则
        assetsDeviceScrapDetail.formValidate($('#form'));
