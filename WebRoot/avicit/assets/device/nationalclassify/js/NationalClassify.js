 ...
 *
 */
function NationalClassify(datagrid, url, searchD, form, keyWordId, searchNames, dataGridColModel) {
...
//初始化操作
NationalClassify.prototype.init = function () {
    var _self = this;
    $(_self._datagridId).jqGrid({
        url: this.getUrl() + 'getNationalClassifysByPage.json',
        mtype: 'POST',
        datatype: "json",
        toolbar: [true, 'top'],
...
//添加页面
NationalClassify.prototype.insert = function () {
...
//编辑页面
NationalClassify.prototype.modify = function () {
...
//详细页
NationalClassify.prototype.detail = function (id) {
...
//打开高级查询框
NationalClassify.prototype.openSearchForm = function (searchDiv) {
    var _self = this;
...
NationalClassify.prototype.formValidate = function (form) {
    form.validate({
        rules: {
            parentid: {
                maxlength: 64
...
//保存功能
NationalClassify.prototype.save = function (form, id) {
    var _self = this;
    avicAjax.ajax({
...
//删除
NationalClassify.prototype.del = function () {
...
//重载数据
NationalClassify.prototype.reLoad = function () {
...
//关闭对话框
NationalClassify.prototype.closeDialog = function (id) {
    if (id == "insert") {
...
//高级查询
NationalClassify.prototype.searchData = function () {
    var searchdata = {
        keyWord: null,
...
//关键字段查询
NationalClassify.prototype.searchByKeyWord = function () {
...
//隐藏查询框
NationalClassify.prototype.hideSearchForm = function () {
    layer.close(searchDialogindex);
};
/*清空查询条件*/
NationalClassify.prototype.clearData = function () {
