function AssetsUstdCollectCm(datagrid, url, formSub, dataGridColModel, searchDialogSub, pid, searchSubNames, demoSubUser_KeyWord, isReload) {
 ...
 * 初始化操作
 */
AssetsUstdCollectCm.prototype.init = function (pid) {
    var _self = this;
    if (_self.isReload == "true") {
        $(_self._datagridId).jqGrid({
            url: _self.getUrl() + 'getAssetsUstdCollectCm',
            postData: {pid: _self.pid},
            mtype: 'POST',
            datatype: "json",
            toolbar: [true, 'top'],
            colModel: assetsUstdCollectCmGridColModel,
...
//禁止时间和日期格式手输
    ...
    //初始化校验字段
    _self.lengthValidFiled.push("stdIdCm");
...
AssetsUstdCollectCm.prototype.insert = function () {
    var _self = this;
 ...
 * @param
 */
AssetsUstdCollectCm.prototype.nullvalid = function (data, item, nullfiled, notnullFiledComment) {
    var msg = "";
 ...
 * @param
 */
AssetsUstdCollectCm.prototype.lengthvalid = function (data, item, lengthValidFiled, lengthValidFiledComment, lengthValidFiledSize) {
    var msg = "";
    $.each(data, function (i, dataitem) {
 ...
 * 长度和非空校验
 */
AssetsUstdCollectCm.prototype.valid = function () {
    var _self = this;
    $(_self._datagridId).jqGrid('endEditCell');
 ...
 * @param pid
 */
AssetsUstdCollectCm.prototype.save = function (pid) {
    var _self = this;
    _self.pid = pid;
    $(_self._datagridId).jqGrid('endEditCell');
    var data = $(_self._datagridId).jqGrid('getRowData');
 ...
 * 删除
 */
AssetsUstdCollectCm.prototype.del = function () {
    var _self = this;
    //删除之前结束单元格
    $(_self._datagridId).jqGrid('endEditCell');
 ...
 * 重载数据
 */
AssetsUstdCollectCm.prototype.reLoad = function (pid) {
    if (pid != undefined) {
        this.pid = pid;
    }
    pid = this.pid;
 ...
 * 关闭对话框
 */
AssetsUstdCollectCm.prototype.closeDialog = function (id) {
    if (id == "insert") {
 ...
 * 打开高级查询框
 */
AssetsUstdCollectCm.prototype.openSearchForm = function (searchDiv, par) {
    var _self = this;
    par = null;
    //if(!par) par = $(window);
 ...
 * 高级查询
 */
AssetsUstdCollectCm.prototype.searchData = function () {
 ...
 * 关键字段查询
 */
AssetsUstdCollectCm.prototype.searchByKeyWord = function () {
 ...
 * 隐藏查询框
 */
AssetsUstdCollectCm.prototype.hideSearchForm = function () {
    layer.close(searchDialogindex);
};
/**
 * 清空查询条件
 */
AssetsUstdCollectCm.prototype.clearData = function () {
