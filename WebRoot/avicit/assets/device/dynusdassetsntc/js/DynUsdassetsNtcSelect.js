...
function DynUsdassetsNtc(datagrid, url, searchForm, dataGridColModel,searchDialog, afterInit, clickRowLoad, searchMainNames,demoMainDept_KeyWord) {
	...
	var _url = "platform/assets/device/dynusdassetsntc/dynUsdassetsNtcController/operation/";
 ...
 * 初始化操作
 */
var param = JSON.stringify({bpmState:'ended'});
...
DynUsdassetsNtc.prototype.submit = function(){
    var _self = this;
    if(!callBackFn){
        layer.alert('找不到回调函数！', {
            icon: 7,
