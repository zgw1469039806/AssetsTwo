 ...
 */
function DynReconMsg(datagrid, url, searchForm, dataGridColModel,searchDialog, afterInit, clickRowLoad, searchMainNames,demoMainDept_KeyWord) {
	...
	this._formCode = "assetsReconstructionMsg"; //表单的code，启动流程时需要
 ...
 * 保存方法
 */
DynReconMsg.prototype.save=function(form,windowName,dataSub){
	var _self = this;
 ...
 * 关闭对话框
 */
DynReconMsg.prototype.closeDialog=function(windowName){
	layer.close(layer.getFrameIndex(windowName));
};
/**
 * 打开高级查询框
 */
DynReconMsg.prototype.openSearchForm = function(searchDiv,par){
	var _self = this;
	par = null;
	//if(!par) par = $(window);
 ...
 * 隐藏查询框
 */
DynReconMsg.prototype.hideSearchForm =function(){
