function AssetsReconstructionR(datagrid, url, formSub, dataGridColModel,searchDialogSub, pid, searchSubNames, demoSubUser_KeyWord, isReload){
 ...
 * 初始化操作
 */
AssetsReconstructionR.prototype.init=function(pid){
	var _self = this;
	if(_self.isReload == "true"){
			$(_self._datagridId).jqGrid({
			url: _self.getUrl()+'getAssetsReconstructionR',
	    	postData : {pid : _self.pid},
	        mtype: 'POST',
	        datatype: "json",
	        toolbar: [true,'top'],
	        colModel: assetsReconstructionRGridColModel, 
...
//禁止时间和日期格式手输
	...
	//初始化校验字段
    																					   					     _self.notnullFiled.push("reconstructionIdR");
				     _self.notnullFiledComment.push("改造申请单号");
				     				      _self.lengthValidFiled.push("reconstructionIdR");
				      _self.lengthValidFiledSize.push(50);
				      _self.lengthValidFiledComment.push("改造申请单号");
				     				    																		   					     				      _self.lengthValidFiled.push("createdByDeptR");
				      _self.lengthValidFiledSize.push(50);
				      _self.lengthValidFiledComment.push("申请人部门");
				     				    															   					     				      _self.lengthValidFiled.push("formStateR");
				      _self.lengthValidFiledSize.push(10);
				      _self.lengthValidFiledComment.push("单据状态");
				     				    																														   					     				      _self.lengthValidFiled.push("ownerDeptR");
				      _self.lengthValidFiledSize.push(50);
				      _self.lengthValidFiledComment.push("责任部门");
				     				    															   					     				      _self.lengthValidFiled.push("ownerIdR");
				      _self.lengthValidFiledSize.push(50);
				      _self.lengthValidFiledComment.push("责任人");
				     				    															   					     				      _self.lengthValidFiled.push("ownerTelR");
				      _self.lengthValidFiledSize.push(50);
				      _self.lengthValidFiledComment.push("责任人联系方式");
				     				    															   					     				      _self.lengthValidFiled.push("deviceNameR");
				      _self.lengthValidFiledSize.push(30);
				      _self.lengthValidFiledComment.push("设备名称");
				     				    															   					     				      _self.lengthValidFiled.push("secretLevelR");
				      _self.lengthValidFiledSize.push(10);
				      _self.lengthValidFiledComment.push("密级");
				     				    															   					     				      _self.lengthValidFiled.push("unifiedIdR");
				      _self.lengthValidFiledSize.push(50);
				      _self.lengthValidFiledComment.push("统一编号");
				     				    															   					     				      _self.lengthValidFiled.push("deviceModelR");
				      _self.lengthValidFiledSize.push(50);
				      _self.lengthValidFiledComment.push("设备型号");
				     				    															   					     				      _self.lengthValidFiled.push("deviceSpecR");
				      _self.lengthValidFiledSize.push(50);
				      _self.lengthValidFiledComment.push("设备规格");
				     				    															   					     				      _self.lengthValidFiled.push("manufacturerIdR");
				      _self.lengthValidFiledSize.push(50);
				      _self.lengthValidFiledComment.push("生产厂家");
				     				    															   					     				     				    															   					     				     				    															   					     				      _self.lengthValidFiled.push("existingPerformanceR");
				      _self.lengthValidFiledSize.push(1024);
				      _self.lengthValidFiledComment.push("现有结构性能指标");
				     				    															   					     				      _self.lengthValidFiled.push("reformingReasonR");
				      _self.lengthValidFiledSize.push(1024);
				      _self.lengthValidFiledComment.push("改造理由");
				     				    															   					     				      _self.lengthValidFiled.push("afterPerformanceR");
				      _self.lengthValidFiledSize.push(1024);
				      _self.lengthValidFiledComment.push("改造后结构性能指标");
				     				    															   					     				      _self.lengthValidFiled.push("transformWayR");
				      _self.lengthValidFiledSize.push(1024);
				      _self.lengthValidFiledComment.push("改造途径");
				     				    															   					     				      _self.lengthValidFiled.push("budgetR");
				      _self.lengthValidFiledSize.push(50);
				      _self.lengthValidFiledComment.push("经费预算");
				     				    																																																																											   					     				     				    															   					     				      _self.lengthValidFiled.push("deviceCategoryR");
				      _self.lengthValidFiledSize.push(10);
				      _self.lengthValidFiledComment.push("设备类别");
				     				    															   					     				      _self.lengthValidFiled.push("createdByPersonR");
				      _self.lengthValidFiledSize.push(50);
...
AssetsReconstructionR.prototype.insert = function(){
	var _self = this;
 ...
 * @param 
 */
AssetsReconstructionR.prototype.nullvalid = function(data,item,nullfiled,notnullFiledComment){
	var msg = "";
 ...
 * @param 
 */
AssetsReconstructionR.prototype.lengthvalid = function(data,item,lengthValidFiled,lengthValidFiledComment,lengthValidFiledSize){
	var msg = "";
	$.each(data,function(i,dataitem){
 ...
 * 长度和非空校验
 */
 AssetsReconstructionR.prototype.valid=function(){
	    var _self = this;
	    $(_self._datagridId).jqGrid('endEditCell');
  ...
  * @param pid
  */
 AssetsReconstructionR.prototype.save = function(pid){
 	var _self = this;
 	_self.pid = pid;
 	$(_self._datagridId).jqGrid('endEditCell');
 	var data = $(_self._datagridId).jqGrid('getRowData');	
  ...
  * 删除
  */
AssetsReconstructionR.prototype.del = function(){
 	var _self = this;
 	//删除之前结束单元格
 	$(_self._datagridId).jqGrid('endEditCell');
	...
	if(isAddRow && notAddRow){
		...
		$('#cb_assetsReconstructionR').click();
		return false;
	}
 	if(l > 0){
 ...
 * 重载数据
 */
AssetsReconstructionR.prototype.reLoad=function(pid){
	if(pid != undefined){
		this.pid = pid;
	}
	pid = this.pid;
 ...
 * 获取子表数据
 */
AssetsReconstructionR.prototype.getSubData=function(){
	var _self = this;
	$(_self._datagridId).jqGrid('endEditCell');
 	var data = $(_self._datagridId).jqGrid('getRowData');
 ...
 * 关闭对话框
 */
AssetsReconstructionR.prototype.closeDialog=function(id){
	if(id == "insert"){
 ...
 * 打开高级查询框
 */
AssetsReconstructionR.prototype.openSearchForm = function(searchDiv,par){
	var _self = this;
	par = null;
	//if(!par) par = $(window);
 ...
 * 高级查询
 */
AssetsReconstructionR.prototype.searchData =function(){
 ...
 * 关键字段查询
 */
AssetsReconstructionR.prototype.searchByKeyWord =function(){
 ...
 * 隐藏查询框
 */
AssetsReconstructionR.prototype.hideSearchForm =function(){
	layer.close(searchDialogindex);
};
/**
 * 清空查询条件
 */
AssetsReconstructionR.prototype.clearData =function(){
