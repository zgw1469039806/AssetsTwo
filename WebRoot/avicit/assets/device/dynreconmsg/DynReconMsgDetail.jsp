...
<html>
<head>
<!-- ControllerPath = "assets/device/dynreconmsg/dynReconMsgController/operation/toDetailJsp" -->
...
<body>
					...
					<form id='form'>
						...
						<table class="form_commonTable">
							<tr>
									    										...
									    										<td width="15%">
																				    <input class="form-control input-sm" type="text" name="author"  id="author" />
																			   </td>
																											   															 																										 																																					<th width="10%">
										...
										<th width="99%" colspan="<%=4 * 2 %>">
											...
											<table id="assetsReconstructionCheck" name="ASSETS_RECONSTRUCTION_CHECK" class="customform_subtable_bpm_auth"></table>
											         											    																																				 														...
											         											    																																				 														<pt6:h5resource label="责任人" name="ownerIdAlias" ref_table="ASSETS_RECONSTRUCTION_CHECK"></pt6:h5resource> 
											         											    																																				 											         	...
											         											    																																				 											         	<pt6:h5resource label="密级" name="secretLevelName" ref_table="ASSETS_RECONSTRUCTION_CHECK"></pt6:h5resource> 
											         											    																																				 														...
											         											    																																				 														<pt6:h5resource label="申请人" name="createdByPersonAlias" ref_table="ASSETS_RECONSTRUCTION_CHECK"></pt6:h5resource> 
											         											    																					</th>
									</tr>
									<tr>
	...
	<!-- 业务的js -->
	<script type="text/javascript" src="avicit/assets/device/dynreconmsg/js/DynReconMsgDetail.js"></script>
  ...
  function initOnceInAdd(){
		avicAjax.ajax({
			 url:"platform/assets/device/dynreconmsg/dynReconMsgController/getLookUpCode",
			 type : 'post',
			 dataType : 'json',
			 async:false,
			 success : function(r){
	...
	var assetsReconstructionCheckGridColModel = null;
			...
			assetsReconstructionCheckGridColModel=[
                            ...
                            ,{ label: '责任人id', name: 'ownerId', width: 75, hidden:true }
   	                        ...
   	                        ,{ label: '密级', name: 'secretLevelName', width: 150,  edittype:"custom", editoptions: {custom_element:selectElem,custom_value:selectValue, forId:'secretLevel', value: secretLevelData}}
   	                        ...
   	                        ,{ label: '设备类别', name: 'deviceCategoryName', width: 150,  edittype:"custom", editoptions: {custom_element:selectElem,custom_value:selectValue, forId:'deviceCategory', value: deviceCategoryData}}
									        							  		   			 											   				   													,{ label: '申请人', name: 'createdByPersonAlias', width: 150, edittype:'custom',editoptions:{custom_element:userElem,custom_value:userValue, forId:'createdByPerson'}}
                            ,{ label: '申请人id', name: 'createdByPerson', width: 75, hidden:true }
																		  		   			 	];
			...
			//创建业务操作JS
			var dynReconMsgDetail = new DynReconMsgDetail('form',assetsReconstructionCheck);
			//创建流程操作JS
			new FlowEditor(dynReconMsgDetail);
			...
			//绑定表单验证规则
			dynReconMsgDetail.formValidate($('#form'));
			//初始化附件上传组件
