...
<% 
	...
	String attribute02 = request.getParameter("attribute02");
%>
<!DOCTYPE html>
<html>
<head>
<!-- ControllerPath = "assets/device/assetsreconstructioncheck/assetsReconstructionCheckController/operation/toDetailJsp" -->
...
<div class="panel-main">
	...
	<form id='form'>
		...
		<table class="form_commonTable">
			<tr>
				...
				<td width="15%">
					<input class="form-control input-sm" type="text" name="reconstructionId"  id="reconstructionId" />
				</td>
				<th width="10%">
			...
			<tr>
				...
				<td width="15%">
					<div class="input-group input-group-sm">
						<input class="form-control date-picker" type="text" name="likaDate" id="likaDate" /><span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
					</div>
				</td>
				<th width="10%">
				...
				<td width="15%">
					<input class="form-control input-sm" type="text" name="existingPerformance"  id="existingPerformance" />
				</td>
				<th width="10%">
					<label for="reformingReason">改造理由:</label></th>
				<td width="15%">
					<input class="form-control input-sm" type="text" name="reformingReason"  id="reformingReason" />
				</td>
			</tr>
			<tr>
				<th width="10%">
				...
				<td width="15%">
					<input class="form-control input-sm" type="text" name="afterPerformance"  id="afterPerformance" />
				</td>
				<th width="10%">
					<label for="transformWay">改造途径:</label></th>
				<td width="15%">
					<input class="form-control input-sm" type="text" name="transformWay"  id="transformWay" />
				</td>
				<th width="10%">
					<label for="budget">经费预算:</label></th>
				<td width="15%">
					<input class="form-control input-sm" type="text" name="budget"  id="budget" />
					<input class="form-control input-sm" type="text" name="attribute02"  id="attribute02" style="display: none" />
				</td>
				<th width="10%">
	...
	<!-- 业务的js -->
	<script src="avicit/assets/device/assetsreconstructioncheck/js/AssetsReconstructionCheckDetail.js"></script>
	<script type="text/javascript">
		comId = '<%=comId%>';
		$("#attribute01").val(comId);
		attribute02 = '<%=attribute02%>';
		$("#attribute02").val(attribute02);
			//注册附件上传完毕后执行的方法
		var afterUploadEvent = null;
		$(document).ready(function () {
			//创建业务操作JS
			var assetsReconstructionCheckDetail = new AssetsReconstructionCheckDetail('form');
			//创建流程操作JS
			...
			//绑定表单验证规则
			assetsReconstructionCheckDetail.formValidate($('#form'));
			...
			$("#saveForm").on("click", function () {
				assetsReconstructionCheckDetail.save();
			})
