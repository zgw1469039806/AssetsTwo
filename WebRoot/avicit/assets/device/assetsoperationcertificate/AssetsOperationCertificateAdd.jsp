...
<html>
<head>
    <!-- ControllerPath = "assets/device/assetsoperationcertificate/assetsOperationCertificateController/operation/Add/null" -->
    <title>添加</title>
...
<script type="text/javascript">
    function closeForm() {
        parent.assetsOperationCertificate.closeDialog("insert");
    }
    ...
    function saveForm() {
        ...
        parent.assetsOperationCertificate.save($('#form'), "insert");
    }
