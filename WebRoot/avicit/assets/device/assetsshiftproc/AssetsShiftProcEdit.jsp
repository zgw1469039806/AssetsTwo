...
<html>
<head>
    <!-- ControllerPath = "assets/device/assetsshiftproc/assetsShiftProcController/operation/Edit/id" -->
    <title>编辑</title>
...
<div data-options="region:'center',split:true,border:false">
    <form id='form'>
        <input type="hidden" name="version" value="<c:out  value='${assetsShiftProcDTO.version}'/>"/>
        ...
        <table class="form_commonTable">
            <tr>
                ...
                <td width="15%">
                    <input class="form-control input-sm" type="text" name="shiftNo" id="shiftNo"
                ...
                <td width="15%">
                    <input class="form-control input-sm" type="text" name="createdByTel" id="createdByTel"
                           value="<c:out  value='${assetsShiftProcDTO.createdByTel}'/>"/>
                </td>
                <th width="10%" style="word-break:break-all;word-warp:break-word;">
            ...
            <tr>
                ...
                <td width="15%">
                    <textarea class="form-control input-sm" rows="3" name="shiftReason" id="shiftReason"><c:out
                            value='${assetsShiftProcDTO.shiftReason}'/></textarea>
                </td>
            </tr>
            <tr>
                <th width="10%" style="word-break:break-all;word-warp:break-word;">
            ...
            <tr>
                ...
                <td width="15%">
                    <input class="form-control input-sm" type="text" name="useVoltage" id="useVoltage"
                           value="<c:out  value='${assetsShiftProcDTO.useVoltage}'/>"/>
                </td>
                <th width="10%" style="word-break:break-all;word-warp:break-word;">
            ...
            <tr>
                ...
                <td width="15%">
                    <textarea class="form-control input-sm" rows="3" name="humidityNeed" id="humidityNeed"><c:out
                            value='${assetsShiftProcDTO.humidityNeed}'/></textarea>
                </td>
                <th width="10%" style="word-break:break-all;word-warp:break-word;">
                ...
                <td width="15%">
                    <textarea class="form-control input-sm" rows="3" name="cleanlinessNeed" id="cleanlinessNeed"><c:out
                            value='${assetsShiftProcDTO.cleanlinessNeed}'/></textarea>
                </td>
                <th width="10%" style="word-break:break-all;word-warp:break-word;">
            ...
            <tr>
                ...
                <td width="15%">
                    <textarea class="form-control input-sm" rows="3" name="waterNeed" id="waterNeed"><c:out
                            value='${assetsShiftProcDTO.waterNeed}'/></textarea>
                </td>
                <th width="10%" style="word-break:break-all;word-warp:break-word;">
                ...
                <td width="15%">
                    <textarea class="form-control input-sm" rows="3" name="gasNeed" id="gasNeed"><c:out
                            value='${assetsShiftProcDTO.gasNeed}'/></textarea>
                </td>
                <th width="10%" style="word-break:break-all;word-warp:break-word;">
            ...
            <tr>
                ...
                <td width="15%">
                    <textarea class="form-control input-sm" rows="3" name="letNeed" id="letNeed"><c:out
                            value='${assetsShiftProcDTO.letNeed}'/></textarea>
                </td>
                <th width="10%" style="word-break:break-all;word-warp:break-word;">
                ...
                <td width="15%">
                    <textarea class="form-control input-sm" rows="3" name="otherNeed" id="otherNeed"><c:out
                            value='${assetsShiftProcDTO.otherNeed}'/></textarea>
                </td>
                <th width="10%" style="word-break:break-all;word-warp:break-word;">
            ...
            <tr>
                <td width="50%" style="padding-right:4%;" align="right">
                    <a href="javascript:void(0)" class="btn btn-primary form-tool-btn typeb btn-sm" role="button"
                       title="保存" id="assetsShiftProc_saveForm">保存</a>
                    <a href="javascript:void(0)" class="btn btn-grey form-tool-btn btn-sm" role="button" title="返回"
                       id="assetsShiftProc_closeForm">返回</a>
                </td>
            </tr>
        </table>
    </div>
...
<script type="text/javascript">
    function closeForm() {
        parent.assetsShiftProc.closeDialog(window.name);
    }
    ...
    function saveForm() {
        ...
        //限制保存按钮多次点击
        $('#assetsShiftProc_saveForm').addClass('disabled').unbind("click");
        parent.assetsShiftProc.save($('#form'), window.name, callback);
    }
    ...
    $(document).ready(function () {
        ...
        //绑定表单验证规则
        parent.assetsShiftProc.formValidate($('#form'));
        //保存按钮绑定事件
        $('#assetsShiftProc_saveForm').bind('click', function () {
            saveForm();
        });
        //返回按钮绑定事件
        $('#assetsShiftProc_closeForm').bind('click', function () {
            closeForm();
        });
