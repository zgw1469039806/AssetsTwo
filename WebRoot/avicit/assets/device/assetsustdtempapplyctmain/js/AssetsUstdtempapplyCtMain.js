 ...
 */
function AssetsUstdtempapplyCtMain(datagrid, url, searchForm, dataGridColModel, searchDialog, afterInit, clickRowLoad, searchMainNames, demoMainDept_KeyWord) {
    ...
    this._formCode = "assetsUstdtempapplyCtMain"; //表单的code，启动流程时需要
 ...
 * 初始化操作
 */
AssetsUstdtempapplyCtMain.prototype.init = function () {
    var _self = this;
    //初始化流程帮助类
    flowListEditor = new FlowListEditor(this._formCode);
    var issubinit = false;
    $(_self._datagridId).jqGrid({
        url: _self.getUrl() + 'getAssetsUstdtempapplyCtMainsByPage.json',
        mtype: 'POST',
        multiselect: true,
        datatype: "json",
        toolbar: [true, 'top'],
 ...
 * 添加页面
 */
AssetsUstdtempapplyCtMain.prototype.insert = function () {
    //添加流程
 ...
 * 编辑页面
 */
AssetsUstdtempapplyCtMain.prototype.modify = function () {
 ...
 * 详情页面
 */
AssetsUstdtempapplyCtMain.prototype.detail = function (id, value) {
    flowUtils.detail(id);
};
/**
 * 控件校验   规则：表单字段name与rules对象保持一致
 */
AssetsUstdtempapplyCtMain.prototype.formValidate = function (form) {
    form.validate({
        rules: {
            author: {
                maxlength: 50
 ...
 * 保存方法
 */
AssetsUstdtempapplyCtMain.prototype.save = function (form, id) {
    var _self = this;
 ...
 * 删除方法
 */
AssetsUstdtempapplyCtMain.prototype.del = function () {
    var _self = this;
 ...
 * 重载数据
 */
AssetsUstdtempapplyCtMain.prototype.reLoad = function () {
    var searchdata = {
        keyWord: null,
 ...
 * 关闭对话框
 */
AssetsUstdtempapplyCtMain.prototype.closeDialog = function (windowName) {
    layer.close(layer.getFrameIndex(windowName));
};
/**
 * 打开高级查询框
 */
AssetsUstdtempapplyCtMain.prototype.openSearchForm = function (searchDiv, par) {
    var _self = this;
    par = null;
    //if(!par) par = $(window);
 ...
 * 高级查询
 */
AssetsUstdtempapplyCtMain.prototype.searchData = function () {
 ...
 * 关键字段查询
 */
AssetsUstdtempapplyCtMain.prototype.searchByKeyWord = function () {
 ...
 * 隐藏查询框
 */
AssetsUstdtempapplyCtMain.prototype.hideSearchForm = function () {
    layer.close(searchDialogindex);
};
/**
 * 根据流程状态查询
 */
AssetsUstdtempapplyCtMain.prototype.initWorkFlow = function (status) {
    $('#bpmState').val(status);
    if (status == "start") {
        $("#assetsUstdtempapplyCtMain_modify").show();
        $("#assetsUstdtempapplyCtMain_del").show();
    } else {
        $("#assetsUstdtempapplyCtMain_modify").hide();
        $("#assetsUstdtempapplyCtMain_del").hide();
    }
    this.searchData();
};
/**
 * 清空查询条件
 */
AssetsUstdtempapplyCtMain.prototype.clearData = function () {
