 ...
 * formcode
 */
EformFlow.prototype.formcode = "assetsUstdtempapplyCtMain";
...
EformFlow.prototype.start = function (defineId, callback) {
	...
	//子表数据
	$('#assetsUstdtempapplyCollect').jqGrid('endEditCell');
	var dataSub = JSON.stringify($('#assetsUstdtempapplyCollect').jqGrid('getRowData'));
