 ...
 */
function AssetsApplyModule(datagrid, url, searchDialogId, form, keyWordId, searchNames, dataGridColModel){
 ...
 * 初始化操作
 */
AssetsApplyModule.prototype.init = function(){
	var _self = this;
	$(_self._datagridId).jqGrid({
    	url: this.getUrl() + 'getAssetsApplyModulesByPage.json',
        mtype: 'POST',
        datatype: "json",
	...
	//初始化校验字段
    																																											   					     _self.lengthValidFiled.push("isContractRelated");
				     _self.lengthValidFiledSize.push(10);
				    																							   					     _self.lengthValidFiled.push("applyType");
				     _self.lengthValidFiledSize.push(50);
				    																							   					     _self.lengthValidFiled.push("applyId");
				     _self.lengthValidFiledSize.push(50);
				    																							   					     _self.lengthValidFiled.push("applyDeviceName");
				     _self.lengthValidFiledSize.push(50);
				    																							   																							   																							   					     _self.lengthValidFiled.push("applySpec");
				     _self.lengthValidFiledSize.push(50);
				    																							   					     _self.lengthValidFiled.push("applyModel");
				     _self.lengthValidFiledSize.push(50);
				    																							   					     _self.lengthValidFiled.push("applyManufacturer");
				     _self.lengthValidFiledSize.push(50);
				    																							   					     _self.lengthValidFiled.push("contractId");
				     _self.lengthValidFiledSize.push(50);
				    																							   					     _self.lengthValidFiled.push("contractNum");
				     _self.lengthValidFiledSize.push(50);
				    																							   					     _self.lengthValidFiled.push("contractName");
				     _self.lengthValidFiledSize.push(50);
				    																							   					     _self.lengthValidFiled.push("contractTotalPrice");
				     _self.lengthValidFiledSize.push(50);
				    																							   					     _self.lengthValidFiled.push("contractSupplier");
				     _self.lengthValidFiledSize.push(50);
				    																							   					     _self.lengthValidFiled.push("contractOperator");
				     _self.lengthValidFiledSize.push(50);
				    																							   					     _self.lengthValidFiled.push("contractDeviceName");
				     _self.lengthValidFiledSize.push(50);
				    																							   																							   																							   																							   					     _self.lengthValidFiled.push("contractSpec");
				     _self.lengthValidFiledSize.push(50);
				    																							   					     _self.lengthValidFiled.push("contractModel");
				     _self.lengthValidFiledSize.push(50);
				    																							   					     _self.lengthValidFiled.push("contractManufacturer");
				     _self.lengthValidFiledSize.push(50);
				    																							   					     _self.lengthValidFiled.push("contractState");
				     _self.lengthValidFiledSize.push(50);
				    																																																																																			   					     _self.lengthValidFiled.push("isDerive");
				     _self.lengthValidFiledSize.push(50);
				    										};
 /**
 * 添加页面
...
AssetsApplyModule.prototype.insert = function(){
	var _self = this;
 ...
 * @param 
 */
AssetsApplyModule.prototype.nullvalid = function(data,item,nullfiled,notnullFiledComment){
	var msg = "";
 ...
 * @param 
 */
AssetsApplyModule.prototype.lengthvalid = function(data,item,lengthValidFiled,lengthValidFiledComment,lengthValidFiledSize){
	var msg = "";
	$.each(data,function(i,dataitem){
 ...
 * @param callback
 */
AssetsApplyModule.prototype.save = function(){
	var _self = this;
 ...
 * @param id
 */
AssetsApplyModule.prototype.detail = function(id){
 ...
 * 删除
 */
AssetsApplyModule.prototype.del = function(){
 ...
 * 重载数据
 */
AssetsApplyModule.prototype.reLoad = function(){
	var searchdata = {
		keyWord: null,
 ...
 */
AssetsApplyModule.prototype.openSearchForm = function(searchDiv){
	var _self = this;
 ...
 * 高级查询
 */
AssetsApplyModule.prototype.searchData = function(){
	var searchdata = {
		keyWord: null,
		param:JSON.stringify(serializeObject($(this._formId)))
	}
 ...
 * 关键字查询
 */
AssetsApplyModule.prototype.searchByKeyWord = function(){
