...
<html>
<head>
<!-- ControllerPath = "avicit/cadreselect/dynTemplate/dynTemplateController/operation/Add/null" -->
<title>添加</title>
...
<body class="easyui-layout" fit="true">
	...
	<script type="text/javascript">
		...
		function closeForm(){
			parent.dynTemplate.closeDialog("insert");
		}
		...
		function saveForm(){
			...
			parent.dynTemplate.save($('#form'),"insert");
		}
		//清空日期值
