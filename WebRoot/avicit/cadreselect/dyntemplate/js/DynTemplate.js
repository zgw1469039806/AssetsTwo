 ...
 */
function DynTemplate(datagrid,url,searchD,form,keyWordId,searchNames,dataGridColModel){
 ...
 * 初始化操作
 */
DynTemplate.prototype.init=function(){
	var _self = this;
	$(_self._datagridId).jqGrid({
    	url: _self.getUrl()+'getDynTemplatesByPage.json',
        mtype: 'POST',
        datatype: "json",
        toolbar: [true,'top'],
 ...
 * 添加页面
 */
DynTemplate.prototype.insert=function(){
 ...
 * 编辑页面
 */
DynTemplate.prototype.modify=function(){
 ...
 * 详情页面
 */
DynTemplate.prototype.detail=function(id){
 ...
 * 打开高级查询框
 */
DynTemplate.prototype.openSearchForm = function(searchDiv){
	var _self = this;
 ...
 */
DynTemplate.prototype.formValidate=function(form){
	form.validate({
		rules: {
			temTitle:{
			},
 ...
 * 保存方法
 */
DynTemplate.prototype.save=function(form,id){
	var _self = this;
	avicAjax.ajax({
 ...
 * 删除方法
 */
DynTemplate.prototype.del=function(){
	var _self = this;
 ...
 * 重载数据
 */
DynTemplate.prototype.reLoad=function(){
 ...
 * 关闭对话框
 */
DynTemplate.prototype.closeDialog=function(id){
	if(id == "insert"){
 ...
 * 后台查询	
 */
DynTemplate.prototype.searchData =function(){
 ...
 * 快速查询
 */
DynTemplate.prototype.searchByKeyWord =function(){
 ...
 * 隐藏查询框
 */
DynTemplate.prototype.hideSearchForm =function(){
	layer.close(searchDialogindex);
};
/**
 * 清空查询条件
 */
DynTemplate.prototype.clearData =function(){
