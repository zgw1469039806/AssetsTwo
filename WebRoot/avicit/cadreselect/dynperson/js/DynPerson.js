 ...
 */
function DynPerson(datagrid,url,searchD,form,keyWordId,searchNames,dataGridColModel){
 ...
 * 初始化操作
 */
DynPerson.prototype.init=function(){
	var _self = this;
	$(_self._datagridId).jqGrid({
    	url: _self.getUrl()+'getDynPersonsByPage.json',
        mtype: 'POST',
        datatype: "json",
        toolbar: [true,'top'],
 ...
 * 添加页面
 */
DynPerson.prototype.insert=function(){
 ...
 * 编辑页面
 */
DynPerson.prototype.modify=function(){
 ...
 * 详情页面
 */
DynPerson.prototype.detail=function(id){
 ...
 * 打开高级查询框
 */
DynPerson.prototype.openSearchForm = function(searchDiv){
	var _self = this;
 ...
 */
DynPerson.prototype.formValidate=function(form){
	form.validate({
		rules: {
			perName:{
				required:true
 ...
 * 保存方法
 */
DynPerson.prototype.save=function(form,id){
	var _self = this;
	avicAjax.ajax({
 ...
 * 删除方法
 */
DynPerson.prototype.del=function(){
	var _self = this;
 ...
 * 重载数据
 */
DynPerson.prototype.reLoad=function(){
 ...
 * 关闭对话框
 */
DynPerson.prototype.closeDialog=function(id){
	if(id == "insert"){
 ...
 * 后台查询	
 */
DynPerson.prototype.searchData =function(){
 ...
 * 快速查询
 */
DynPerson.prototype.searchByKeyWord =function(){
 ...
 * 隐藏查询框
 */
DynPerson.prototype.hideSearchForm =function(){
	layer.close(searchDialogindex);
};
/**
 * 清空查询条件
 */
DynPerson.prototype.clearData =function(){
