...
<html>
<head>
<!-- ControllerPath = "avicit/cadreselect/dynPerson/dynPersonController/operation/Add/null" -->
<title>添加</title>
...
<body class="easyui-layout" fit="true">
	...
	<script type="text/javascript">
		...
		function closeForm(){
			parent.dynPerson.closeDialog("insert");
		}
		...
		function saveForm(){
			...
			parent.dynPerson.save($('#form'),"insert");
		}
		//清空日期值
