 ...
 */
function DynVote(datagrid,url,searchD,form,keyWordId,searchNames,dataGridColModel){
 ...
 * 初始化操作
 */
DynVote.prototype.init=function(){
	var _self = this;
	$(_self._datagridId).jqGrid({
    	url: _self.getUrl()+'getDynVotesByPage.json',
        mtype: 'POST',
        datatype: "json",
        toolbar: [true,'top'],
 ...
 * 添加页面
 */
DynVote.prototype.insert=function(){
 ...
 * 编辑页面
 */
DynVote.prototype.modify=function(){
 ...
 * 详情页面
 */
DynVote.prototype.detail=function(id){
 ...
 * 打开高级查询框
 */
DynVote.prototype.openSearchForm = function(searchDiv){
	var _self = this;
 ...
 */
DynVote.prototype.formValidate=function(form){
	form.validate({
		rules: {
			dynItId:{
			},
 ...
 * 保存方法
 */
DynVote.prototype.save=function(form,id){
	var _self = this;
	avicAjax.ajax({
 ...
 * 删除方法
 */
DynVote.prototype.del=function(){
	var _self = this;
 ...
 * 重载数据
 */
DynVote.prototype.reLoad=function(){
 ...
 * 关闭对话框
 */
DynVote.prototype.closeDialog=function(id){
	if(id == "insert"){
 ...
 * 后台查询	
 */
DynVote.prototype.searchData =function(){
 ...
 * 快速查询
 */
DynVote.prototype.searchByKeyWord =function(){
 ...
 * 隐藏查询框
 */
DynVote.prototype.hideSearchForm =function(){
	layer.close(searchDialogindex);
};
/**
 * 清空查询条件
 */
DynVote.prototype.clearData =function(){
