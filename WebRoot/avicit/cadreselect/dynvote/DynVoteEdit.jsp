...
<body class="easyui-layout" fit="true">
    			...
    			<tr>
					...
					<td>
						<div class="input-group input-group-sm spinner" data-trigger="spinner">
							<input  class="form-control"  type="text" name="dynVoteLog" id="dynVoteLog" data-min="-9999999999999999999999" data-max="9999999999999999999999" data-step="1" data-precision="0" value="<c:out value='${dynVoteDTO.dynVoteLog}'/>">
	...
	<script type="text/javascript">
		...
		function closeForm(){
			parent.dynVote.closeDialog("edit");
		}
		function saveForm(){
