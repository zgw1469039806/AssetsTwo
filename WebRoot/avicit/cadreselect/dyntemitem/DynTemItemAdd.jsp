...
<html>
<head>
<!-- ControllerPath = "avicit/cadreselect/dynTemItem/dynTemItemController/operation/Add/null" -->
<title>添加</title>
...
<body class="easyui-layout" fit="true">
    			...
    			<tr>
					...
					<td>
						<div class="input-group input-group-sm">
							<input class="form-control date-picker" type="text" name="tiStartDate" id="tiStartDate" />
					...
					<td>
						<div class="input-group input-group-sm">
							<input class="form-control date-picker" type="text" name="tiEndDate" id="tiEndDate" />
							<span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
							<span class="input-group-addon"  onclick="clearCommonSelectValue(this)"><i class="fa fa-close"></i></span>
						</div>
   					</td>
	...
	<script type="text/javascript">
		...
		function closeForm(){
			parent.dynTemItem.closeDialog("insert");
		}
		...
		function saveForm(){
			...
			parent.dynTemItem.save($('#form'),"insert");
		}
		//清空日期值
