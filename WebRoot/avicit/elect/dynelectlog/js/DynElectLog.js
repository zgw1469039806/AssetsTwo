 ...
 */
function DynElectLog(datagrid,url,searchD,form,keyWordId,searchNames,dataGridColModel){
 ...
 * 初始化操作
 */
DynElectLog.prototype.init=function(){
	var _self = this;
	$(_self._datagridId).jqGrid({
    	url: _self.getUrl()+'getDynElectLogsByPage.json',
        mtype: 'POST',
        datatype: "json",
        toolbar: [true,'top'],
 ...
 * 添加页面
 */
DynElectLog.prototype.insert=function(){
 ...
 * 编辑页面
 */
DynElectLog.prototype.modify=function(){
 ...
 * 详情页面
 */
DynElectLog.prototype.detail=function(id){
 ...
 * 打开高级查询框
 */
DynElectLog.prototype.openSearchForm = function(searchDiv){
	var _self = this;
 ...
 */
DynElectLog.prototype.formValidate=function(form){
	form.validate({
		rules: {
			electId:{
			},
 ...
 * 保存方法
 */
DynElectLog.prototype.save=function(form,id){
	var _self = this;
	avicAjax.ajax({
 ...
 * 删除方法
 */
DynElectLog.prototype.del=function(){
	var _self = this;
 ...
 * 重载数据
 */
DynElectLog.prototype.reLoad=function(){
 ...
 * 关闭对话框
 */
DynElectLog.prototype.closeDialog=function(id){
	if(id == "insert"){
 ...
 * 后台查询	
 */
DynElectLog.prototype.searchData =function(){
 ...
 * 快速查询
 */
DynElectLog.prototype.searchByKeyWord =function(){
 ...
 * 隐藏查询框
 */
DynElectLog.prototype.hideSearchForm =function(){
	layer.close(searchDialogindex);
};
/**
 * 清空查询条件
 */
DynElectLog.prototype.clearData =function(){
