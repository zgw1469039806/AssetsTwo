 ...
 */
function DynPersons(datagrid,url,searchD,form,keyWordId,searchNames,dataGridColModel){
 ...
 * 初始化操作
 */
DynPersons.prototype.init=function(){
	var _self = this;
	$(_self._datagridId).jqGrid({
    	url: _self.getUrl()+'getDynPersonssByPage.json',
        mtype: 'POST',
        datatype: "json",
        toolbar: [true,'top'],
 ...
 * 添加页面
 */
DynPersons.prototype.insert=function(){
 ...
 * 编辑页面
 */
DynPersons.prototype.modify=function(){
 ...
 * 详情页面
 */
DynPersons.prototype.detail=function(id){
 ...
 * 打开高级查询框
 */
DynPersons.prototype.openSearchForm = function(searchDiv){
	var _self = this;
 ...
 */
DynPersons.prototype.formValidate=function(form){
	form.validate({
		rules: {
			no:{
			},
 ...
 * 保存方法
 */
DynPersons.prototype.save=function(form,id){
	var _self = this;
	avicAjax.ajax({
 ...
 * 删除方法
 */
DynPersons.prototype.del=function(){
	var _self = this;
 ...
 * 重载数据
 */
DynPersons.prototype.reLoad=function(){
 ...
 * 关闭对话框
 */
DynPersons.prototype.closeDialog=function(id){
	if(id == "insert"){
 ...
 * 后台查询	
 */
DynPersons.prototype.searchData =function(){
 ...
 * 快速查询
 */
DynPersons.prototype.searchByKeyWord =function(){
 ...
 * 隐藏查询框
 */
DynPersons.prototype.hideSearchForm =function(){
	layer.close(searchDialogindex);
};
/**
 * 清空查询条件
 */
DynPersons.prototype.clearData =function(){
