 ...
 */
function DynNumPlate(datagrid,url,searchD,form,keyWordId,searchNames,dataGridColModel){
 ...
 * 初始化操作
 */
DynNumPlate.prototype.init=function(){
	var _self = this;
	$(_self._datagridId).jqGrid({
    	url: _self.getUrl()+'getDynNumPlatesByPage.json',
        mtype: 'POST',
        datatype: "json",
        toolbar: [true,'top'],
 ...
 * 添加页面
 */
DynNumPlate.prototype.insert=function(){
 ...
 * 编辑页面
 */
DynNumPlate.prototype.modify=function(){
 ...
 * 详情页面
 */
DynNumPlate.prototype.detail=function(id){
 ...
 * 打开高级查询框
 */
DynNumPlate.prototype.openSearchForm = function(searchDiv){
	var _self = this;
 ...
 */
DynNumPlate.prototype.formValidate=function(form){
	form.validate({
		rules: {
			num:{
			},
 ...
 * 保存方法
 */
DynNumPlate.prototype.save=function(form,id){
	var _self = this;
	avicAjax.ajax({
 ...
 * 删除方法
 */
DynNumPlate.prototype.del=function(){
	var _self = this;
 ...
 * 重载数据
 */
DynNumPlate.prototype.reLoad=function(){
 ...
 * 关闭对话框
 */
DynNumPlate.prototype.closeDialog=function(id){
	if(id == "insert"){
 ...
 * 后台查询	
 */
DynNumPlate.prototype.searchData =function(){
 ...
 * 快速查询
 */
DynNumPlate.prototype.searchByKeyWord =function(){
 ...
 * 隐藏查询框
 */
DynNumPlate.prototype.hideSearchForm =function(){
	layer.close(searchDialogindex);
};
/**
 * 清空查询条件
 */
DynNumPlate.prototype.clearData =function(){
