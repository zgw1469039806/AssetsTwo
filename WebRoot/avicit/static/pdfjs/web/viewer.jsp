...
<head>
    ...
    <link rel="stylesheet" href="avicit/static/pdfjs/web/viewer.css">
    <!-- This snippet is used in production (included from viewer.html) -->
    <link rel="resource" type="application/l10n" href="avicit/static/pdfjs/web/locale/locale.properties">
    ...
    <script type="text/javascript">
        ...
        $.ajax({
            ...
            url: 'cihs/viewer/cihsViewController/getShowFiles',
    ...
    <script src="avicit/static/pdfjs/build/pdf.js"></script>
    <script src="avicit/static/pdfjs/web/viewer.js"></script>
</head>
